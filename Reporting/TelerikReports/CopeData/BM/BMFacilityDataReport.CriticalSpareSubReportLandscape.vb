...
Public Class BmCopeDataReport_CriticalSparesSubReportLandscape
    ...
    Private Function GetDataSource() As DataTable
        ...
        Dim zCmd As New SqlClient.SqlCommand("SELECT * FROM rv.vwBMCopeCriticalSpares WHERE filePrefix='" & rptProperties.FilePrefix & "'", zCon)
    ...
    Private Sub BmCopeDataReport_CriticalSparesSubReport_NeedDataSource(sender As Object, e As System.EventArgs) Handles Me.NeedDataSource
        Me.DataSource = GetDataSource() 'ReportQuery.SubQueries.BoilerFacilityData_CriticalSpares
    End Sub
