...
Public Class BmCopeDataReport_PPESubReportLandscape
    ...
    Private Function GetDataSource() As DataTable
        ...
        Dim zCmd As New SqlClient.SqlCommand("SELECT * FROM rv.vwBMCopePPEa WHERE filePrefix='" & rptProperties.FilePrefix & "'", zCon)
    ...
    End Function
     ...
     Private Sub BmCopeDataReport_PPESubReport_NeedDataSource(sender As Object, e As System.EventArgs) Handles Me.NeedDataSource
        Me.DataSource = GetDataSource() 'ReportQuery.SubQueries.BoilerFacilityData_ProductionProcessEquipment
     End Sub
