...
Public Class BmCopeDataReport_CPVSubReportLandscape
    ...
    Private Sub BmCopeDataReport_CPVSubReport_NeedDataSource(sender As Object, e As System.EventArgs) Handles Me.NeedDataSource
        Me.DataSource = GetDataSource() 'ReportQuery.SubQueries.BoilerFacilityData_Cpv
    End Sub
    ...
    Private Function GetDataSource() As DataTable
        ...
        Dim zCmd As New SqlClient.SqlCommand("SELECT * FROM rv.vwBMCopeCPV WHERE filePrefix='" & rptProperties.FilePrefix & "'", zCon)
