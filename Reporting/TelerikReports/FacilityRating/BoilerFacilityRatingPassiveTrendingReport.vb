...
Partial Public Class BoilerFacilityRatingPassiveTrendingReport
    ...
    Public Sub New()
        ...
        With _GraphBind
            .Add("uxMechanicalSysGraph", "Mech")
            .Add("uxElectricalSystemsGraph", "Elec")
            .Add("uxBVPGraph", "Pressure")
            .Add("uxPPEGraph", "Production")
            .Add("uxOccupancyGraph", "Occupancy")
            .Add("uxComputerSysGraph", "Computer")
        End With
    ...
    Public Function ReportTitle() As String Implements ITelerikReport.ReportTitle
        Return "Facility Rating Physical Assets Trending Chart"
    End Function
    ...
    Private Sub GraphNeedDataSourceHandler(sender As Object, e As EventArgs) Handles uxElectricalSystemsGraph.NeedDataSource, uxBVPGraph.NeedDataSource, uxPPEGraph.NeedDataSource, uxOccupancyGraph.NeedDataSource, uxComputerSysGraph.NeedDataSource, uxMechanicalSysGraph.NeedDataSource
