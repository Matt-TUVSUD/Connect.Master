...
Public Class rptNatHazRecommendationResponsesFollowUp
...
#Region " ActiveReports Designer generated code "
    ...
    Private WithEvents txtHazard As GrapeCity.ActiveReports.SectionReportModel.Label
    ...
    Private WithEvents lblHazard As GrapeCity.ActiveReports.SectionReportModel.Label
    ...
    Private WithEvents lnHazardTop As GrapeCity.ActiveReports.SectionReportModel.Line
    Private WithEvents lnHazardLeft As GrapeCity.ActiveReports.SectionReportModel.Line
    Private WithEvents lnRFU3DateTop As GrapeCity.ActiveReports.SectionReportModel.Line
    Private WithEvents lnHazardRight As GrapeCity.ActiveReports.SectionReportModel.Line
    ...
    Private WithEvents lnHazardBottom As GrapeCity.ActiveReports.SectionReportModel.Line
    ...
    Private WithEvents lnTotalNoRecsRight As GrapeCity.ActiveReports.SectionReportModel.Line
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(rptNatHazRecommendationResponsesFollowUp))
        ...
        Me.txtHazard = New GrapeCity.ActiveReports.SectionReportModel.Label()
        ...
        Me.lblHazard = New GrapeCity.ActiveReports.SectionReportModel.Label()
        ...
        Me.lnHazardTop = New GrapeCity.ActiveReports.SectionReportModel.Line()
        Me.lnHazardLeft = New GrapeCity.ActiveReports.SectionReportModel.Line()
        Me.lnRFU3DateTop = New GrapeCity.ActiveReports.SectionReportModel.Line()
        Me.lnHazardRight = New GrapeCity.ActiveReports.SectionReportModel.Line()
        ...
        Me.lnHazardBottom = New GrapeCity.ActiveReports.SectionReportModel.Line()
        ...
        Me.lnTotalNoRecsRight = New GrapeCity.ActiveReports.SectionReportModel.Line()
        ...
        CType(Me.txtHazard, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.lblHazard, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.lblRecommendationFollowUpReport.Left = 3.5!
        ...
        Me.lblRecommendationFollowUpReport.Text = "NatHaz Recommendation Follow-Up Report"
        Me.lblRecommendationFollowUpReport.Top = 0.35!
        Me.lblRecommendationFollowUpReport.Width = 6.5!
        '
        'lnPageHeaderTop
        '
    ...
    "n: right; vertical-align: middle"
        ...
        'Detail1
        '
        Me.Detail1.Controls.AddRange(New GrapeCity.ActiveReports.SectionReportModel.ARControl() {Me.txtAutoRequest, Me.lblAutoRequest, Me.txtClientLocNo, Me.lblResponseStatus, Me.txtRespDueDate, Me.txtRespRequestDate, Me.txtHazard, Me.txtAddress, Me.txtCity, Me.txtCountry, Me.txtRecipientEmail, Me.txtRecipientName, Me.txtRFU1Date, Me.txtFileNo, Me.txtNoActiveRecs, Me.txtDaysOverdue, Me.txtRFU3Date, Me.txtDivision, Me.lblNoActiveRecs, Me.lblRespRequestDate, Me.lblRecipientEmail, Me.lblRespDueDate, Me.lblNoRecsNeedingResp, Me.lblRFU2Date, Me.txtNoRecsNeedingResp, Me.txtRFU2Date, Me.lnRecipientEmailLeft, Me.lnRecipientEmailTop, Me.lblHazard, Me.lblDaysOverdue, Me.lblRFU3Date, Me.lblRFU1Date, Me.lblRecipientName, Me.txtTIV, Me.txtFacility, Me.lnRespRequestDateLeft, Me.lnRespRequestDateRight, Me.lnRespRequestDateTop, Me.lnRespRequestDateBottom, Me.lnDaysOverdueTop, Me.lnRespDueDateTop, Me.lnRespDueDateBottom, Me.lnDaysOverdueBottom, Me.lnRespDueDateLeft, Me.lnRespDueDateRight, Me.lnDaysOverdueLeft, Me.lnDaysOverdueRight, Me.lnRFU3DateBottom, Me.lnRFU1DateTop, Me.lnRFU1DateBottom, Me.lnRFU2DateTop, Me.lnRecipientNameRight, Me.lnRFU2DateLeft, Me.lnRFU3DateLeft, Me.lnRFU2DateBottom, Me.lnRecipientNameLeft, Me.lnRFU1DateLeft, Me.lnNoActiveRecsTop, Me.lnNoActiveRecsBottom, Me.lnNoRecsNeedingRespTop, Me.lnNoRecsNeedingRespRight, Me.lnNoRecsNeedingRespLeft, Me.lnNoRecsNeedingRespBottom, Me.lnHazardTop, Me.lnHazardLeft, Me.lnRFU3DateTop, Me.lnHazardRight, Me.lnNoActiveRecsRight, Me.lnRFU1DateRight, Me.lnRFU2DateRight, Me.lnRFU3DateRight, Me.lnRecipientNameTop, Me.lnRecipientNameBottom, Me.lnRecipientEmailBottom, Me.txtStProv, Me.lnDetailBottom, Me.lnDetailTop, Me.lnDetailLeft, Me.lnRecipientEmailRight, Me.lnNoActiveRecsLeft, Me.lnHazardBottom, Me.lnDetailRight, Me.txtResponseStatus, Me.lnResponseStatusLeft, Me.lnResponseStatusBottom, Me.lnResponseStatusTop, Me.lnResponseStatusRight, Me.lnAutoRequestRight, Me.lnAutoRequestLeft, Me.lnAutoRequestBottom, Me.lnAutoRequestTop, Me.lblTotalNoRecs, Me.txtTotalNoRecs, Me.lnTotalNoRecsTop, Me.lnTotalNoRecsBottom, Me.lnTotalNoRecsRight, Me.lnTotalNoRecsLeft})
        ...
        'txtHazard
        '
        Me.txtHazard.DataField = "Hazard"
        Me.txtHazard.Height = 0.15!
        Me.txtHazard.HyperLink = Nothing
        Me.txtHazard.Left = 0.9!
        Me.txtHazard.Name = "txtHazard"
        Me.txtHazard.Style = "font-size: 7pt; text-align: center; vertical-align: middle"
        Me.txtHazard.Text = "Hazard"
        Me.txtHazard.Top = 0.35!
        Me.txtHazard.Width = 0.5!
        '
        'txtAddress
        '
        ...
        Me.txtNoRecsNeedingResp.Top = 0.755!
        ...
        'lblHazard
        '
        Me.lblHazard.Height = 0.15!
        Me.lblHazard.HyperLink = Nothing
        Me.lblHazard.Left = 0.0!
        Me.lblHazard.Name = "lblHazard"
        Me.lblHazard.Style = "font-size: 7pt; font-weight: bold; text-align: right; vertical-align: middle"
        Me.lblHazard.Text = "Hazard"
        Me.lblHazard.Top = 0.35!
        Me.lblHazard.Width = 0.85!
        '
        'lblDaysOverdue
        '
        ...
        'lnHazardTop
        '
        Me.lnHazardTop.Height = 0.0!
        Me.lnHazardTop.Left = 0.9!
        Me.lnHazardTop.LineWeight = 1.0!
        Me.lnHazardTop.Name = "lnHazardTop"
        Me.lnHazardTop.Top = 0.35!
        Me.lnHazardTop.Width = 0.5!
        Me.lnHazardTop.X1 = 0.9!
        Me.lnHazardTop.X2 = 1.4!
        Me.lnHazardTop.Y1 = 0.35!
        Me.lnHazardTop.Y2 = 0.35!
        '
        'lnHazardLeft
        '
        Me.lnHazardLeft.Height = 0.15!
        Me.lnHazardLeft.Left = 0.9!
        Me.lnHazardLeft.LineWeight = 1.0!
        Me.lnHazardLeft.Name = "lnHazardLeft"
        Me.lnHazardLeft.Top = 0.35!
        Me.lnHazardLeft.Width = 0.0!
        Me.lnHazardLeft.X1 = 0.9!
        Me.lnHazardLeft.X2 = 0.9!
        Me.lnHazardLeft.Y1 = 0.35!
        Me.lnHazardLeft.Y2 = 0.5!
        '
        'lnRFU3DateTop
        '
        ...
        'lnHazardRight
        '
        Me.lnHazardRight.Height = 0.15!
        Me.lnHazardRight.Left = 1.4!
        Me.lnHazardRight.LineWeight = 1.0!
        Me.lnHazardRight.Name = "lnHazardRight"
        Me.lnHazardRight.Top = 0.35!
        Me.lnHazardRight.Width = 0.0!
        Me.lnHazardRight.X1 = 1.4!
        Me.lnHazardRight.X2 = 1.4!
        Me.lnHazardRight.Y1 = 0.35!
        Me.lnHazardRight.Y2 = 0.5!
        '
        'lnNoActiveRecsRight
        '
        ...
        'lnRFU3DateRight
        '
        Me.lnRFU3DateRight.Height = 0.15!
        ...
        'lnHazardBottom
        '
        Me.lnHazardBottom.Height = 0.0!
        Me.lnHazardBottom.Left = 0.9!
        Me.lnHazardBottom.LineWeight = 1.0!
        Me.lnHazardBottom.Name = "lnHazardBottom"
        Me.lnHazardBottom.Top = 0.5!
        Me.lnHazardBottom.Width = 0.5!
        Me.lnHazardBottom.X1 = 0.9!
        Me.lnHazardBottom.X2 = 1.4!
        Me.lnHazardBottom.Y1 = 0.5!
        Me.lnHazardBottom.Y2 = 0.5!
        '
        'lnDetailRight
        '
        ...
        'lnTotalNoRecsRight
        '
        Me.lnTotalNoRecsRight.Height = 0.15!
        Me.lnTotalNoRecsRight.Left = 3.5!
        Me.lnTotalNoRecsRight.LineWeight = 1.0!
        Me.lnTotalNoRecsRight.Name = "lnTotalNoRecsRight"
        Me.lnTotalNoRecsRight.Top = 0.35!
        Me.lnTotalNoRecsRight.Width = 0.0!
        Me.lnTotalNoRecsRight.X1 = 3.5!
        Me.lnTotalNoRecsRight.X2 = 3.5!
        Me.lnTotalNoRecsRight.Y1 = 0.35!
        Me.lnTotalNoRecsRight.Y2 = 0.5!
        '
        'lnTotalNoRecsLeft
        '
        ...
        Me.txtDisclaimer.Top = 0.29!
        Me.txtDisclaimer.Width = 10.0!
        '
        'rptNatHazRecommendationResponsesFollowUp
        '
        ...
        CType(Me.txtHazard, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.lblHazard, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Private Sub rptNatHazRecommendationResponsesFollowUp_FetchData(ByVal sender As Object, ByVal eArgs As FetchEventArgs) Handles Me.FetchData
    ...
    Private Sub rptNatHazRecommendationResponsesFollowUp_ReportStart(ByVal sender As Object, ByVal e As EventArgs) Handles Me.ReportStart
    ...
    Private Sub rptNatHazRecommendationResponsesFollowUp_PageStart(ByVal sender As Object, ByVal e As EventArgs) Handles Me.PageStart
    ...
    Private Sub rptNatHazRecommendationResponsesFollowUp_ReportEnd(ByVal sender As Object, ByVal e As EventArgs) Handles Me.ReportEnd
        DisposeParameters()
    End Sub
