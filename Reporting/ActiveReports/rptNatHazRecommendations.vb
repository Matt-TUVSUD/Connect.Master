...
Public Class rptNatHazRecommendations
...
#Region " ActiveReports Designer generated code "
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(rptNatHazRecommendations))
        ...
        Me.lblRecommendationsReport.Left = 4.21!
        ...
        Me.lblRecommendationsReport.Text = "All NatHaz Recommendation Report"
        Me.lblRecommendationsReport.Top = 0.35!
        Me.lblRecommendationsReport.Width = 5.8!
        '
        'lnPageHeaderTop
        '
        ...
        Me.lblClientName.Left = 5.710011!
    ...
    "n: right; vertical-align: middle"
        ...
        Me.PageFooter1.Height = 0.4229167!
...
#End Region
    ...
    Private Sub rptNatHazRecommendations_FetchData(ByVal sender As Object, ByVal eArgs As FetchEventArgs) Handles Me.FetchData
        Dim zTextControls() As ARControl = {txtImpact}
        UtilReport.ActiveReport.SetItemBackColorByText(Me, zTextControls, rptProperties)

        If Not IsNothing(Me.AllFields("ExpectedCompletionDateColor").Value) AndAlso Me.AllFields("ExpectedCompletionDateColor").Value.ToString.ToLower <> "transparent" Then
    ...
    Private Sub rptNatHazRecommendations_ReportStart(ByVal sender As Object, ByVal e As EventArgs) Handles Me.ReportStart
    ...
    Private Sub rptNatHazRecommendations_PageStart(ByVal sender As Object, ByVal e As EventArgs) Handles Me.PageStart
    ...
    Private Sub rptNatHazRecommendations_ReportEnd(ByVal sender As Object, ByVal e As EventArgs) Handles Me.ReportEnd
        DisposeParameters()
    End Sub
