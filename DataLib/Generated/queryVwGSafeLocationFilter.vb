...
Namespace razor
    Public Class queryVwGSafeLocationFilter
        ...
        Public colClient1 As New razor.UtilSQLServer.StringDataColumn
        ...
        Public Sub New()
            ...
            _Members.Add("colClient1", colClient1)
        ...
        Public Function Column2Member(pColumnName As String) As String
            Select Case pColumnName
                ...
                Case "[Client1]", "Client1", "Client1", "colClient1"  
                    Return "colClient1"
        ...
        Private Function _TableName() As String
            Return "[gv].[vwGSafeLocationFilter]"
        End Function
