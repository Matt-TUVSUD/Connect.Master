...
// Date Generated       : 5/30/2019 10:57:38 AM
//===============================================================================
...
(function (es) { //myNS = "myNameSpace" ... for example purposes
	...
	es.objects.ViewCCLocationListingFireRating = es.defineEntity(function () {
	...
	es.objects.ViewCCLocationListingFireRating.prototype.esTypeDefs = {};

	es.objects.ViewCCLocationListingFireRating.prototype.esRoutes = {
		commit: { method: 'PUT', url: 'ViewCCLocationListingFireRating_Save', response: 'entity' }
	};

	es.objects.ViewCCLocationListingFireRating.prototype.esColumnMap = {
		'Client': 1,
		'PracticeCode': 1,
		'Facility': 1,
		'ClientLocNo': 1,
...
(function (es) {
	...
	es.objects.ViewCCLocationListingFireRatingCollection = es.defineCollection('ViewCCLocationListingFireRatingCollection', 'ViewCCLocationListingFireRating');

	//#region Prototype Level Information

	es.objects.ViewCCLocationListingFireRatingCollection.prototype.esRoutes = {
		commit: { method: 'PUT', url: 'ViewCCLocationListingFireRatingCollection_Save', response: 'collection' },
		loadAll: { method: 'GET', url: 'ViewCCLocationListingFireRatingCollection_LoadAll', response: 'collection' }
	};
