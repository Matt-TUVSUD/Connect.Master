...
(function (es) { //myNS = "myNameSpace" ... for example purposes
	...
	es.objects.ViewCCLocationListingRecResponseBM = es.defineEntity(function () {
		...
		this.BMReportArchiveID = ko.observable();
		...
		this.ToBMReport2 = ko.observable();
	...
	es.objects.ViewCCLocationListingRecResponseBM.prototype.esTypeDefs = {};

	es.objects.ViewCCLocationListingRecResponseBM.prototype.esRoutes = {
		commit: { method: 'PUT', url: 'ViewCCLocationListingRecResponseBM_Save', response: 'entity' }
	};

	es.objects.ViewCCLocationListingRecResponseBM.prototype.esColumnMap = {
...
(function (es) {
	...
	es.objects.ViewCCLocationListingRecResponseBMCollection = es.defineCollection('ViewCCLocationListingRecResponseBMCollection', 'ViewCCLocationListingRecResponseBM');

	//#region Prototype Level Information

	es.objects.ViewCCLocationListingRecResponseBMCollection.prototype.esRoutes = {
		commit: { method: 'PUT', url: 'ViewCCLocationListingRecResponseBMCollection_Save', response: 'collection' },
		loadAll: { method: 'GET', url: 'ViewCCLocationListingRecResponseBMCollection_LoadAll', response: 'collection' }
	};
