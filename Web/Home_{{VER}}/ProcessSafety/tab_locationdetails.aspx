<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tab_locationdetails.aspx.vb" Inherits="GRC.Connect.Web.tab_locationdetails_processsafety" %>
...
<head runat="server">
    ...
    <script src="../../Lib_{{VER}}/Generated/ViewCCLocationInspectionPS.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Generated/ViewCCLocationListingPS.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Custom/ViewCCLocationInspectionPS.js" type="text/javascript"></script>
...
<body>
    ...
    <div class="tableDiv">
        <div class="tabRow">
            ...
            <span class="documentsLabels"><label data-bind="text: $parent.objLanguageLabels().lblDateCurrentER">Date of Current Rpt</label></span>
            <span class="documentsInputs"><input data-bind="" id="PSActualDate" class="k-autocomplete k-numerictextbox inputCenter inputNoEdit documentsInputs" readonly="true" /></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs"><input data-bind="" id="PSEmailedDate" class="k-autocomplete k-numerictextbox inputCenter inputNoEdit documentsInputs" readonly="true" /></span>
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            <span class="bufferLeft12"></span>
            <span class="documentsLabels"><label data-bind="text: $parent.objLanguageLabels().lblLinkCurrentER">Link to Current Rpt</label></span>
            <span class="documentsInputs">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink documentsInputs" style="line-height: normal;" id="lblToReportClickHere">
                    <label class="linkPointer" data-bind="visible: $parent.objListing().ToPSReport, text: $parent.objLanguageLabels().lblClickHere, click: function (data) { $parent.onBuildLink($parent.objListing().ToPSReport()) }"></label>
                </span>
            </span>           
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink documentsInputs" style="line-height: normal;" id="lblToDiagramClickHere">
                    <label class="linkPointer" data-bind="visible: $parent.objListing().ToPSDiagram, text: $parent.objLanguageLabels().lblClickHere, click: function (data) { $parent.onBuildLink($parent.objListing().ToPSDiagram()) }"></label>
                </span>
            </span>
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            <span class="bufferLeft12"></span>
            <span class="documentsLabels"><label data-bind="text: $parent.objLanguageLabels().lblDatePreviousER">Date of Previous Rpt</label></span>
            <span class="documentsInputs"><input data-bind="" id="PSLastInspectionDate" class="k-autocomplete k-numerictextbox inputCenter inputNoEdit documentsInputs" readonly="true" /></span>
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            <span class="bufferLeft12"></span>
            <span class="documentsLabels"><label data-bind="text: $parent.objLanguageLabels().lblLinkPreviousER">Link to Previous Rpt</label></span>
            <span class="documentsInputs">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink documentsInputs" style="line-height: normal;" id="lblLastInspectionReportClickHere">
                    <label class="linkPointer" data-bind="visible: $parent.objListing().PSLastInspectionReport, text: $parent.objLanguageLabels().lblClickHere, click: function (data) { $parent.onBuildLink($parent.objListing().PSLastInspectionReport()) }"></label>
                </span>
            </span>
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            ...
            <span class="buttonCell">
                <div class="buttonContainer" style="display:flex;">
                    ...
                    <span><button data-bind="click: $parent.onPrevious, enable: $parent.enablePrev" class="grcBlueBtn pagerBtn" id="btnPrevious"><i class="fa fa-caret-left"></i></button></span>
                    ...
                    <span><button data-bind="click: $parent.onNext, enable: $parent.enableNext" class="grcBlueBtn pagerBtn" id="btnNext" style="margin-right:2px;"><i class="fa fa-caret-right"></i></button></span>
    ...
    <div id="windowNoLocation" class="windowContent" style="font-size:13px;">
        ...
        <div style="margin-bottom:5px;"><label data-bind="text: $parent.objLanguageLabels().lblNoLocationFoundMessage">Warning: There is no Location Detail record found for this file number.</label></div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var view_LocationDetails = {
            ...
            collInspection: new es.objects.ViewCCLocationInspectionPSCollection(),
            ...
            resetPickers: function () {
                ...
                if (view_LocationDetails.objListing().PSEmailedDate() == null || view_LocationDetails.objListing().PSEmailedDate() == undefined || view_LocationDetails.objListing().PSEmailedDate() == "" || view_LocationDetails.objListing().PSEmailedDate() == "Mon Jan 1 00:00:00 EST 1900")
                { PSEmailedDate.value(""); } else { PSEmailedDate.value(view_LocationDetails.objListing().PSEmailedDate()); }
                if (view_LocationDetails.objListing().PSActualDate() == null || view_LocationDetails.objListing().PSActualDate() == undefined || view_LocationDetails.objListing().PSActualDate() == "" || view_LocationDetails.objListing().PSActualDate() == "Mon Jan 1 00:00:00 EST 1900")
                { PSActualDate.value(""); } else { PSActualDate.value(view_LocationDetails.objListing().PSActualDate()); }
                if (view_LocationDetails.objListing().PSLastInspectionDate() == null || view_LocationDetails.objListing().PSLastInspectionDate() == undefined || view_LocationDetails.objListing().PSLastInspectionDate() == "" || view_LocationDetails.objListing().PSLastInspectionDate() == "Mon Jan 1 00:00:00 EST 1900")
                { PSLastInspectionDate.value(""); } else { PSLastInspectionDate.value(view_LocationDetails.objListing().PSLastInspectionDate()); }
            ...
            loadDetailsOnly: function () {
                ...
                if (view_LocationDetails.stateDetailsLoadOneRecord == true && view_LocationDetails.stateLoadError == false) {
                    if (!view_LocationDetails.collInspection.ViewCCLocationInspectionPSCollections(tempParm + "|one")) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                    view_LocationDetails.stateDetailsLoadOneRecord = false;
                    view_LocationDetails.stateOnlyOneDetailRecordLoaded = true;
                } else {
                    if (!view_LocationDetails.collInspection.ViewCCLocationInspectionPSCollections(tempParm + "|all")) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                    view_LocationDetails.stateDetailsLoadOneRecord = false;
            ...
            loadOneFileNumber: function () {
                ...
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view_LocationDetails.collListing.ViewCCLocationPSCollections(tempParm)) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                view_LocationDetails.stateListingLoadOneRecord = false;

                tempParm = view_LocationDetails.gSafeGuid + "|one";
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view_LocationDetails.collInspection.ViewCCLocationInspectionPSCollections(tempParm)) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                view_LocationDetails.stateDetailsLoadOneRecord = false;
                view_LocationDetails.stateOnlyOneDetailRecordLoaded = true;
        ...
        var PSEmailedDate = $("#PSEmailedDate").kendoDatePicker({
            value: view_LocationDetails.objListing().PSEmailedDate(),
            format: "dd-MMM-yy"
        }).data("kendoDatePicker");
        PSEmailedDate.wrapper
            .find(".k-picker-wrap").addClass("expand-padding").css("height", "13px").css("width", "113px").find(".k-select").hide();

        var PSActualDate = $("#PSActualDate").kendoDatePicker({
            value: view_LocationDetails.objListing().PSActualDate(),
            format: "dd-MMM-yy"
        }).data("kendoDatePicker");
        PSActualDate.wrapper
            .find(".k-picker-wrap").addClass("expand-padding").css("height", "13px").css("width", "113px").find(".k-select").hide();
        ...
        var PSLastInspectionDate = $("#PSLastInspectionDate").kendoDatePicker({
            value: view_LocationDetails.objListing().PSLastInspectionDate(),
            format: "dd-MMM-yy"
        }).data("kendoDatePicker");
        PSLastInspectionDate.wrapper
            .find(".k-picker-wrap").addClass("expand-padding").css("height", "13px").css("width", "113px").find(".k-select").hide();
