...
Public Class DefaultBoiler
    ...
    Private Sub ValidatePage()
        ...
        CorrectPageCheck(zGUID, PageId_LocationListing_Boiler, PageId_LocationListing_Boiler)
    ...
    Private Sub loadDefaults()
        SetBoilerPractice(GetGUIDFromQueryString)
    End Sub
    ...
    Protected Sub rptFileNo_ItemCommand(source As Object, e As System.Web.UI.WebControls.RepeaterCommandEventArgs) Handles rptFileNo.ItemCommand
        ...
        SetValue(zGuid, KeyName.currentTab, PageId_Boiler, KeyNameGroup.Navigation)
        SetBoilerDetailsPractice(zGuid)

        Response.Redirect("~/Home_{{VER}}/Boiler/locationdetails.aspx?sid=" & zGuid)
    End Sub
