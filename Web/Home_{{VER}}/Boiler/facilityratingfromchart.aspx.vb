...
Public Class FacilityRatingFromChart_boiler
        ...
        If Not Request.QueryString("p1") Is Nothing Then
            If Request.QueryString("p1").Length > 0 Then
                ...
                If IsValidLocation(zGUID, zFileNo) Then
                    UtilGSafe.SetValue(zGUID, UtilGSafe.KeyName.FileNoFromChart, zFileNo, UtilGSafe.KeyNameGroup.LocationSelection)
                Else
        ...
        If Not Request.UrlReferrer Is Nothing Then
            If Request.UrlReferrer.ToString.Length > 0 Then
                If InStr(Request.UrlReferrer.LocalPath.ToLower, "SiteMap/Default.aspx".ToLower) > 0 Then
                    ...
                    Response.Redirect("~/Home_{{VER}}/Grids/LocationListings/LocationListings.aspx?sid=" & zGUID & "&pLandingPage=facilityratingfromchart", False)
                End If
            End If
        End If
