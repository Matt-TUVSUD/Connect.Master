<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tab_recdatasheet.aspx.vb" Inherits="GRC.Connect.Web.tab_recdatasheet_fire" %>
        ...
        <div class="tableDiv">
            ...
            <div class="tabRow" style="display:flex;">
                ...
                <span class="buttonContainerLocationLoading">
                    <span><button data-bind="click: $parent.onFileFirst, enable: $parent.enableFilePrev" type="button" class="grcBlueBtn pagerBtn" id="btnFileFirst" tabindex="15" style="margin-right:2px;"></button></span>
                    <span><button data-bind="click: $parent.onFilePrevious, enable: $parent.enableFilePrev" type="button" class="grcBlueBtn pagerBtn" id="btnFilePrevious" tabindex="16"></button></span>
                    ...
                    <span><button data-bind="click: $parent.onFileNext, enable: $parent.enableFileNext" type="button" class="grcBlueBtn pagerBtn" id="btnFileNext" tabindex="17" style="margin-right:2px;"></button></span>
                    <span><button data-bind="click: $parent.onFileLast, enable: $parent.enableFileNext" type="button" class="grcBlueBtn pagerBtn" id="btnFileLast" tabindex="18"></button></span>
                    <span>&nbsp;</span>
