<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tab_locationdetails.aspx.vb" Inherits="GRC.Connect.Web.tab_locationdetails_fire" %>
...
<body>
    ...
    <div class="tableDiv">
        ...
        <div style="display:flex;">
            ...
            <span class="buttonContainerLocationLoading" style="display:flex;">
                <span>
                    <button data-bind="click: $parent.onFileFirst, enable: $parent.enableFilePrev" type="button" class="grcBlueBtn pagerBtn" id="btnFileFirst" tabindex="15" style="margin-right:2px;"><i class="fas fa-step-backward"></i></button>
                </span>
    ...
    <div class="tableDivAutoBordersGray" style="padding:10px 0;">
    <div class="tableDiv">
        <%--<div class="ui-helper-clearfix">
            <!-- EMPTY ROW AT TOP MUST HAVE HEIGHT SPECIFIED OR IT WILL BE 23px -->
            <span class="bufferLeft12" style="height: 10px;"></span>
            <span class="documentsLabels" style="height: 10px;">&nbsp;</span>
            <span class="documentsInputs" style="height: 10px;">&nbsp;</span>
            <span class="borderRightGray" style="height: 10px;"></span>
            <span class="schedulingLabels" style="height: 10px;">&nbsp;</span>
            <span class="schedulingInputs" style="height: 10px;">&nbsp;</span>
            <span class="borderRightGray" style="height: 10px;"></span>
            <span class="locationsLabels1" style="height: 10px;">&nbsp;</span>
            <span class="locationsInputs1" style="height: 10px;">&nbsp;</span>
            <span class="locationsLabels2" style="height: 10px;">&nbsp;</span>  
            <span class="locationsInputs1" style="height: 10px;">&nbsp;</span>
        ...
        <div style="display:flex;">
            ...
            <span class="documentsInputs"><input data-bind="" id="FireActualDate" class="k-autocomplete k-numerictextbox inputCenter inputNoEdit documentsInputs" readonly="true" /></span>
        ...
        <div style="display:flex;">
            ...
            <span class="documentsInputs"><input data-bind="" id="FireEmailedDate" class="k-autocomplete k-numerictextbox inputCenter inputNoEdit documentsInputs" readonly="true" /></span>
            <span class="borderRightGray"></span>
        ...
        <div style="display:flex;">
            ...
            <span class="documentsInputs">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink documentsInputs" style="line-height: normal;" id="lblToReportClickHere">
                    <label class="linkPointer" data-bind="visible: $parent.objListing().ToFireReport, text: $parent.objLanguageLabels().lblClickHere, click: function (data) { $parent.onBuildLink($parent.objListing().ToFireReport()) }"></label>
                </span>
            </span>           
            <span class="borderRightGray"></span>
        ...
        <div style="display:flex;">
            ...
            <span class="documentsInputs">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink documentsInputs" style="line-height: normal;" id="lblToReport2ClickHere">
                    <label class="linkPointer" data-bind="visible: $parent.objListing().ToFireReport2, text: $parent.objLanguageLabels().lblClickHere, click: function (data) { $parent.onBuildLink($parent.objListing().ToFireReport2()) }"></label>
                </span>
            </span>
            <span class="borderRightGray"></span>
        ...
        <div style="display:flex;">
            ...
            <span class="documentsInputs">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink documentsInputs" style="line-height: normal;" id="lblToDiagramClickHere">
                    <label class="linkPointer" data-bind="visible: $parent.objListing().ToFireDiagram, text: $parent.objLanguageLabels().lblClickHere, click: function (data) { $parent.onBuildLink($parent.objListing().ToFireDiagram()) }"></label>
                </span>
            </span>
            <span class="borderRightGray"></span>
        ...
        <div style="display:flex;">
            ...
            <span class="documentsInputs"><input data-bind="" id="FireLastInspectionDate" class="k-autocomplete k-numerictextbox inputCenter inputNoEdit documentsInputs" readonly="true" /></span>
            <span class="borderRightGray"></span>
        ...
        <div style="display:flex;">
            ...
            <span class="documentsInputs">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink documentsInputs" style="line-height: normal;" id="lblLastInspectionReportClickHere">
                    <label class="linkPointer" data-bind="visible: $parent.objListing().FireLastInspectionReport, text: $parent.objLanguageLabels().lblClickHere, click: function (data) { $parent.onBuildLink($parent.objListing().FireLastInspectionReport()) }"></label>
                </span>
            </span>
            <span class="borderRightGray"></span>
        ...
        <div style="display:flex;">
            ...
            <span class="buttonCell" >
                <div class="buttonContainer" style="display:flex;">
                    <span><button data-bind="click: $parent.onFirst, enable: $parent.enablePrev" class="pagerBtn grcBlueBtn" id="btnFirst" style="margin-right:2px;"><i class="fas fa-step-backward"></i></button></span>
                    <span><button data-bind="click: $parent.onPrevious, enable: $parent.enablePrev" class="pagerBtn grcBlueBtn" id="btnPrevious"><i class="fas fa-caret-left"></i></button></span>
                    ...
                    <span><button data-bind="click: $parent.onNext, enable: $parent.enableNext" class="pagerBtn grcBlueBtn" id="btnNext" style="margin-right:2px;"><i class="fas fa-caret-right"></i></button></span>
                    <span><button data-bind="click: $parent.onLast, enable: $parent.enableNext" class="pagerBtn grcBlueBtn" id="btnLast"><i class="fas fa-step-forward"></i></button></span>
                </div>
            </span> 
            <span class="borderRightGray"></span>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var view_LocationDetails = {
                ...
                collInspection: new es.objects.ViewCCLocationInspectionFireCollection(),
                ...
                resetPickers: function () {
                    ...
                    if (view_LocationDetails.objListing().FireEmailedDate() == null || view_LocationDetails.objListing().FireEmailedDate() == undefined || view_LocationDetails.objListing().FireEmailedDate() == "" || view_LocationDetails.objListing().FireEmailedDate() == "Mon Jan 1 00:00:00 EST 1900")
                    { FireEmailedDate.value(""); } else { FireEmailedDate.value(view_LocationDetails.objListing().FireEmailedDate()); }
                    if (view_LocationDetails.objListing().FireActualDate() == null || view_LocationDetails.objListing().FireActualDate() == undefined || view_LocationDetails.objListing().FireActualDate() == "" || view_LocationDetails.objListing().FireActualDate() == "Mon Jan 1 00:00:00 EST 1900")
                    { FireActualDate.value(""); } else { FireActualDate.value(view_LocationDetails.objListing().FireActualDate()); }
                    if (view_LocationDetails.objListing().FireLastInspectionDate() == null || view_LocationDetails.objListing().FireLastInspectionDate() == undefined || view_LocationDetails.objListing().FireLastInspectionDate() == "" || view_LocationDetails.objListing().FireLastInspectionDate() == "Mon Jan 1 00:00:00 EST 1900")
                    { FireLastInspectionDate.value(""); } else { FireLastInspectionDate.value(view_LocationDetails.objListing().FireLastInspectionDate()); }
                    ...
                    //// RESET PLAIN TEXT PICKERS
                    //                $("input .k-input").each(function () {
                    //                    $(this).removeClass("editRequired").addClass("noedit");
                    //                });
                ...
                clearPickers: function (pIsIgnoreTextFields) {
                    // KENDO WIDGETS
                    EngTargetMo.value("");
                    FireEmailedDate.value("");
                    FireActualDate.value("");
                    EffectiveDate.value("");
                    CancelDate.value("");
                    FireLastInspectionDate.value("");
                    DateCompleted.value("");
                ...
                loadDetailsOnly: function () {
                    ...
                    if (view_LocationDetails.stateDetailsLoadOneRecord == true && view_LocationDetails.stateLoadError == false) {
                        if (!view_LocationDetails.collInspection.ViewCCLocationInspectionFireCollections(tempParm + "|one")) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                        view_LocationDetails.stateDetailsLoadOneRecord = false;
                        view_LocationDetails.stateOnlyOneDetailRecordLoaded = true;
                    } else {
                        if (!view_LocationDetails.collInspection.ViewCCLocationInspectionFireCollections(tempParm + "|all")) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                        view_LocationDetails.stateDetailsLoadOneRecord = false;
                ...
                loadOneFileNumber: function () {
                    ...
                    es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                    if (!view_LocationDetails.collListing.ViewCCLocationFireCollections(tempParm)) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                    view_LocationDetails.stateListingLoadOneRecord = false;

                    tempParm = view_LocationDetails.gSafeGuid + "|one";
                    es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                    if (!view_LocationDetails.collInspection.ViewCCLocationInspectionFireCollections(tempParm)) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                    view_LocationDetails.stateDetailsLoadOneRecord = false;
                    view_LocationDetails.stateOnlyOneDetailRecordLoaded = true;
            ...
            var FireEmailedDate = $("#FireEmailedDate").kendoDatePicker({
                value: view_LocationDetails.objListing().FireEmailedDate(),
                format: "dd-MMM-yy"
            }).data("kendoDatePicker");
            FireEmailedDate.wrapper
                .find(".k-picker-wrap").addClass("expand-padding").css("height", "13px").css("width", "113px").find(".k-select").hide();

            var FireActualDate = $("#FireActualDate").kendoDatePicker({
                value: view_LocationDetails.objListing().FireActualDate(),
                format: "dd-MMM-yy"
            }).data("kendoDatePicker");
            FireActualDate.wrapper
                .find(".k-picker-wrap").addClass("expand-padding").css("height", "13px").css("width", "113px").find(".k-select").hide();
            ...
            var FireLastInspectionDate = $("#FireLastInspectionDate").kendoDatePicker({
                value: view_LocationDetails.objListing().FireLastInspectionDate(),
                format: "dd-MMM-yy"
            }).data("kendoDatePicker");
            FireLastInspectionDate.wrapper
                .find(".k-picker-wrap").addClass("expand-padding").css("height", "13px").css("width", "113px").find(".k-select").hide();
