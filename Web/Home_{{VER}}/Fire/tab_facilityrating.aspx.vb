...
Public Class tab_facilityrating_fire
    Inherits System.Web.UI.Page

    Private Sub ValidatePage()
        'CorrectPageCheck(GetGUIDFromQueryString, PageId_FacilityRating_Fire, PageId_FacilityRating_Fire)
    ...
    Private Sub loadDefaults()
        ...
        'SetFireFacilityRatingPractice(GetGUIDFromQueryString)
