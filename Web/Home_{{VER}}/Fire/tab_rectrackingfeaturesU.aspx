<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tab_rectrackingfeaturesU.aspx.vb" Inherits="GRC.Connect.Web.tab_rectrackingfeaturesU" %>
...
<body>
    ...
    widget: $parent.widgetIntendedActionMgmt
            ...
            <div>
                <span class="bufferLeft"></span>
                <span class="buttonCell" style="text-align: left; padding-left: 89px;"><button class="grcBlueBtn tabActionBtn" style="width: 90px;" id="editSave" data-bind="click: $parent.onEditSave, text: $parent.txtEditSave, enable: $parent.enableNoLocationFound">Edit</button></span>
                <span class="buttonCell" style="text-align: left;"><button class="grcRedBtn tabActionBtn" style="width: 90px;" id="cancelDelete" data-bind="visible: $parent.enableDelete, click: $parent.onCancelDelete, text: $parent.txtCancelDelete, enable: $parent.enableNoLocationFound">Delete</button></span>
        ...
        $(document).ready(function () {
            ...
            var view_RecTracking = {
                ...
                setCancelObject: function () {
                    ...
                    if (view_RecTracking.objRec().MgmtRespDate() == undefined) { objCancel.MgmtRespDate = null; } else { objCancel.MgmtRespDate = view_RecTracking.objRec().MgmtRespDate(); }
                ...
                loadDetailsOnly: function () {
                    ...
                    if (view_RecTracking.stateDetailsLoadOneRecord == true && view_RecTracking.stateLoadError == false) {
                        if (!view_RecTracking.collRec.FireRecommendationCollection_BrowseByLocation(tempParm + "|" + tempHemisphere + "|one|False")) { view_RecTracking.stateLoadError = false } else { view_RecTracking.stateLoadError = true }
                        view_RecTracking.stateDetailsLoadOneRecord = false;
                        view_RecTracking.stateOnlyOneDetailRecordLoaded = true;
                    } else {
                        if (!view_RecTracking.collRec.FireRecommendationCollection_BrowseByLocation(tempParm + "|" + tempHemisphere + "|all|False")) { view_RecTracking.stateLoadError = false } else { view_RecTracking.stateLoadError = true }
                        view_RecTracking.stateDetailsLoadOneRecord = false;
