<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tab_locationdetails.aspx.vb" Inherits="GRC.Connect.Web.tab_locationdetails_nathaz" %>
...
<head runat="server">
    ...
    <script src="../../Lib_{{VER}}/Generated/ViewCCLocationInspectionNH.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Generated/ViewCCLocationListingNH.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Custom/ViewCCLocationInspectionNH.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Custom/ViewCCLocationListingNH.js" type="text/javascript"></script>
</head>
<body>
    ...
    <div class="tableDiv">
        <div class="tabRow">
            ...
            <span class="documentsInputs"><input data-bind="" id="NHActualDate" class="k-autocomplete k-numerictextbox inputCenter inputNoEdit documentsInputs" readonly="true" /></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs"><input data-bind="" id="NHEmailedDate" class="k-autocomplete k-numerictextbox inputCenter inputNoEdit documentsInputs" readonly="true" /></span>
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink documentsInputs" style="line-height: normal;" id="lblToReportClickHere">
                    <label class="linkPointer" data-bind="visible: $parent.objListing().ToNHReport, text: $parent.objLanguageLabels().lblClickHere, click: function (data) { $parent.onBuildLink($parent.objListing().ToNHReport()) }"></label>
                </span>
            </span>           
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink documentsInputs" style="line-height: normal;" id="lblToReport2ClickHere">
                    <label class="linkPointer" data-bind="visible: $parent.objListing().ToNHReport2, text: $parent.objLanguageLabels().lblClickHere, click: function (data) { $parent.onBuildLink($parent.objListing().ToNHReport2()) }"></label>
                </span>
            </span>
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink documentsInputs" style="line-height: normal;" id="lblToDiagramClickHere">
                    <label class="linkPointer" data-bind="visible: $parent.objListing().ToNHDiagram, text: $parent.objLanguageLabels().lblClickHere, click: function (data) { $parent.onBuildLink($parent.objListing().ToNHDiagram()) }"></label>
                </span>
            </span>
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs"><input data-bind="" id="NHLastInspectionDate" class="k-autocomplete k-numerictextbox inputCenter inputNoEdit documentsInputs" readonly="true" /></span>
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink documentsInputs" style="line-height: normal;" id="lblLastInspectionReportClickHere">
                    <label class="linkPointer" data-bind="visible: $parent.objListing().NHLastInspectionReport, text: $parent.objLanguageLabels().lblClickHere, click: function (data) { $parent.onBuildLink($parent.objListing().NHLastInspectionReport()) }"></label>
                </span>
            </span>
            <span class="borderRightGray"></span>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var dsLanguageLabels = {
                ...
                lblSearchNotFound: "This location is not active for Natural Hazards.  Choose a different service."
            };
            ...
            var view_LocationDetails = {
                ...
                collInspection: new es.objects.ViewCCLocationInspectionNHCollection(),
                collListing: new es.objects.ViewCCLocationListingNHCollection(),
                ...
                resetPickers: function () {
                    ...
                    if (view_LocationDetails.objListing().NHEmailedDate() == null || view_LocationDetails.objListing().NHEmailedDate() == undefined || view_LocationDetails.objListing().NHEmailedDate() == "" || view_LocationDetails.objListing().NHEmailedDate() == "Mon Jan 1 00:00:00 EST 1900")
                    { NHEmailedDate.value(""); } else { NHEmailedDate.value(view_LocationDetails.objListing().NHEmailedDate()); }
                    if (view_LocationDetails.objListing().NHActualDate() == null || view_LocationDetails.objListing().NHActualDate() == undefined || view_LocationDetails.objListing().NHActualDate() == "" || view_LocationDetails.objListing().NHActualDate() == "Mon Jan 1 00:00:00 EST 1900")
                    { NHActualDate.value(""); } else { NHActualDate.value(view_LocationDetails.objListing().NHActualDate()); }
                    if (view_LocationDetails.objListing().NHLastInspectionDate() == null || view_LocationDetails.objListing().NHLastInspectionDate() == undefined || view_LocationDetails.objListing().NHLastInspectionDate() == "" || view_LocationDetails.objListing().NHLastInspectionDate() == "Mon Jan 1 00:00:00 EST 1900")
                    { NHLastInspectionDate.value(""); } else { NHLastInspectionDate.value(view_LocationDetails.objListing().NHLastInspectionDate()); }
                ...
                loadDetailsOnly: function () {
                    ...
                    if (view_LocationDetails.stateDetailsLoadOneRecord == true && view_LocationDetails.stateLoadError == false) {
                        if (!view_LocationDetails.collInspection.ViewCCLocationInspectionNHCollections(tempParm + "|one")) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                        view_LocationDetails.stateDetailsLoadOneRecord = false;
                        view_LocationDetails.stateOnlyOneDetailRecordLoaded = true;
                    } else {
                        if (!view_LocationDetails.collInspection.ViewCCLocationInspectionNHCollections(tempParm + "|all")) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                        view_LocationDetails.stateDetailsLoadOneRecord = false;
                ...
                loadOneFileNumber: function () {
                    ...
                    es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                    if (!view_LocationDetails.collListing.ViewCCLocationNHCollections(tempParm)) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                    view_LocationDetails.stateListingLoadOneRecord = false;

                    tempParm = view_LocationDetails.gSafeGuid + "|one";
                    es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                    if (!view_LocationDetails.collInspection.ViewCCLocationInspectionNHCollections(tempParm)) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                    view_LocationDetails.stateDetailsLoadOneRecord = false;
                    view_LocationDetails.stateOnlyOneDetailRecordLoaded = true;
            ...
            var NHEmailedDate = $("#NHEmailedDate").kendoDatePicker({
                value: view_LocationDetails.objListing().NHEmailedDate(),
                format: "dd-MMM-yy"
            }).data("kendoDatePicker");
            NHEmailedDate.wrapper
                .find(".k-picker-wrap").addClass("expand-padding").css("height", "13px").css("width", "113px").find(".k-select").hide();

            var NHActualDate = $("#NHActualDate").kendoDatePicker({
                value: view_LocationDetails.objListing().NHActualDate(),
                format: "dd-MMM-yy"
            }).data("kendoDatePicker");
            NHActualDate.wrapper
                .find(".k-picker-wrap").addClass("expand-padding").css("height", "13px").css("width", "113px").find(".k-select").hide();
            ...
            var NHLastInspectionDate = $("#NHLastInspectionDate").kendoDatePicker({
                value: view_LocationDetails.objListing().NHLastInspectionDate(),
                format: "dd-MMM-yy"
            }).data("kendoDatePicker");
            NHLastInspectionDate.wrapper
                .find(".k-picker-wrap").addClass("expand-padding").css("height", "13px").css("width", "113px").find(".k-select").hide();
