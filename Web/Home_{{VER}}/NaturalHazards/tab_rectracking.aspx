<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tab_rectracking.aspx.vb" Inherits="GRC.Connect.Web.tab_rectracking_nathaz" %>
            ...
            var view_RecTracking = {
                ...
                loadDetailsOnly: function () {
                    ...
                    if (view_RecTracking.stateDetailsLoadOneRecord == true && view_RecTracking.stateLoadError == false) {
                        if (!view_RecTracking.collRec.FireRecommendationCollection_BrowseByLocation(tempParm + "|" + tempHemisphere + "|one|True")) { view_RecTracking.stateLoadError = false } else { view_RecTracking.stateLoadError = true }
                        view_RecTracking.stateDetailsLoadOneRecord = false;
                        view_RecTracking.stateOnlyOneDetailRecordLoaded = true;
                    } else {
                        if (!view_RecTracking.collRec.FireRecommendationCollection_BrowseByLocation(tempParm + "|" + tempHemisphere + "|all|True")) { view_RecTracking.stateLoadError = false } else { view_RecTracking.stateLoadError = true }
                        view_RecTracking.stateDetailsLoadOneRecord = false;
