<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tab_rectrackingfeaturesX.aspx.vb" Inherits="GRC.Connect.Web.tab_rectrackingfeaturesX_nathaz" %>
    ...
    <div id="view_RecTracking" data-bind="with: view_RecTracking">
        ...
        <div class="tableDiv">
            ...
            <div>
                ...
                <span class="recLabelRecCode" style="height: 21px;"><label data-bind="text: $parent.objLanguageLabels().lblRecCode">Code</label></span>
                <span class="recInputRecCode" style="height: 21px;"><input data-bind="value: $parent.objRec().RecCode" id="RecCode" class="k-autocomplete k-input inputNoEdit inputLeft recInputRecCode" readonly="readonly" /></span>
                <span class="recLabelRecSmall" style="height: 21px; padding-left: 16px;"><label data-bind="text: $parent.objLanguageLabels().lblRecImpact">Rec. Impact</label></span>
                <span class="recInputRecCategory" id="RecCategory" style="height: 21px;">
                    <select class="inputNoEdit recInputRecCategory" data-bind="kendoDropDownList: {
        ...
        widget: $parent.widgetRecCategory
                ...
                <span class="recInputRecStatus" id="RecStatus" style="height: 21px;">
                    <select  class="inputNoEdit recInputRecStatus" data-bind="kendoDropDownList: {
        ...
        widget: $parent.widgetRecStatus
                ...
                <span class="recLabelRecSmall" style="padding-left: 9px; height: 21px;"><label data-bind="text: $parent.objLanguageLabels().lblStatusDate">Status Date</label></span>
        ...
        widget: $parent.widgetSecondaryRecType
            ...
            <div>
                <span class="bufferLeft"></span>
                <span class="recLabelLeft"><label data-bind="text: $parent.objLanguageLabels().lblActual"></label></span>
        ...
        widget: $parent.widgetCostToComplete
            ...
            <div>
                ...
                <span class="recInputDateSmall"><input data-bind="" id="ResponseDate" class="k-numerictextbox inputCenter inputNoEdit recInputDateSmall" /></span>
        ...
        widget: $parent.widgetIntendedAction
            ...
            <div data-bind="if: $parent.clientFeatures().search('Q') > -1">
                ...
                <span class="recInputDateSmall"><input data-bind="" id="MgmtRespDate" class="k-autocomplete k-input inputCenter inputNoEdit recInputDateSmall" /></span>
        ...
        <div id="windowNoLocation" class="windowContent" style="font-size:13px;">
            ...
            <div style="margin-bottom:5px;"><label data-bind="text: $parent.objLanguageLabels().lblNoLocationFoundMessage">Warning: There are no recommendation records found for this location.</label></di>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var dsLanguageLabels = {
                ...
                lblCurrentLossEst: "Current Loss",
                lblCompletedLossEst: "Completed Loss",
                lblEstCostToComplete: "Cost to Complete",
            ...
            var view_RecTracking = {
                ...
                onDatasheetView: function () {
                    ...
                    var tempURL = "tab_recdatasheetfeaturesX.aspx?sid=" + view_RecTracking.gSafeGuid + "&rec=" + view_RecTracking.index;
                ...
                resetPickers: function () {
                    ...
                    if (view_RecTracking.objRec().ResponseDate() == null || view_RecTracking.objRec().ResponseDate() < view_RecTracking.objRec().StatusDate()) {
                        if (view_RecTracking.objRec().RecStatus() != 'Removed' && view_RecTracking.objRec().RecStatus() != 'Rptd Completed' && view_RecTracking.objRec().RecStatus() != 'Conf Completed') {
                ...
                clearPickers: function () {
                    ...
                    if (view_RecTracking.clientFeatures().indexOf("Q") > -1) { view_RecTracking.widgetIntendedActionMgmt().value(""); }
                ...
                loadOneFileNumber: function () {
                    ...
                    es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                    if (!view_RecTracking.collListing.ViewCCLocationNHCollections(tempParm)) { view_RecTracking.stateLoadError = false } else { view_RecTracking.stateLoadError = true }
                    view_RecTracking.stateListingLoadOneRecord = false;

                    tempParm = view_RecTracking.gSafeGuid + "|" + tempHemisphere + "|one|True";
                    es.dataProvider.baseURL = SITEBASEURL + DATASERVERENDPOINT;
                    if (!view_RecTracking.collRec.FireRecommendationCollection_BrowseByLocation(tempParm)) { view_RecTracking.stateLoadError = false } else { view_RecTracking.stateLoadError = true }
                ...
                loadFileNumber: function () {
                    ...
                    //// LOAD ALL DETAILS
                    var tempHemisphere = getHemisphere(calculate_time_zone());
                    tempParm = view_RecTracking.gSafeGuid + "|" + tempHemisphere + "|all|True";
                    es.dataProvider.baseURL = SITEBASEURL + DATASERVERENDPOINT;
                    if (!view_RecTracking.collRec.FireRecommendationCollection_BrowseByLocation(tempParm)) { view_RecTracking.stateLoadError = false } else { view_RecTracking.stateLoadError = true }
                    view_RecTracking.stateDetailsLoadOneRecord = false;
