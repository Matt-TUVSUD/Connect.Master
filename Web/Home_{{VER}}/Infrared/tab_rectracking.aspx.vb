...
Public Class tab_rectracking_infared
    Inherits System.Web.UI.Page

    Private Sub ValidatePage()
        'CorrectPageCheck(GetGUIDFromQueryString, PageId_RecommendationTracking_Infrared, PageId_LocationListing_Infrared)
        CorrectPageCheck(Request.QueryString("sid"), PageId_LocationDetails_Infrared, PageId_LocationListing_Infrared)
    End Sub
    ...
    Private Sub loadDefaults()
        ...
        'SetIRRecommendationTracking(zGUID)
        SetIRDetailsPractice(zGUID)
        ...
        If Not Request.UrlReferrer Is Nothing Then
            If Request.UrlReferrer.ToString.Length > 0 Then
                If InStr(Request.UrlReferrer.LocalPath.ToLower, "SiteMap/Default.aspx".ToLower) > 0 Then
                    SetValue(zGUID, KeyName.currentGridId, GridId_IRLocationListings, KeyNameGroup.Navigation)
