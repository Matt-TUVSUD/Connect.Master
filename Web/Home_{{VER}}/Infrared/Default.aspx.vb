...
Public Class DefaultInfrared
    ...
    Private Sub ValidatePage()
        ...
        CorrectPageCheck(zGUID, PageId_LocationListing_Infrared, PageId_LocationListing_Infrared)
    ...
    Private Sub loadDefaults()
        SetIRPractice(GetGUIDFromQueryString)
    End Sub
    ...
    Protected Sub rptFileNo_ItemCommand(source As Object, e As System.Web.UI.WebControls.RepeaterCommandEventArgs) Handles rptFileNo.ItemCommand
        ...
        Response.Redirect("~/Home_{{VER}}/Infrared/locationdetails.aspx?sid=" & zGuid)
    End Sub
