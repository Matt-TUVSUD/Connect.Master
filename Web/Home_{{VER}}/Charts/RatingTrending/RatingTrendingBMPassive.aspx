<%@ Page Language="vb"  MasterPageFile="~/Home_{{VER}}/Charts/ChartMasterPageRecommendations.master" AutoEventWireup="false" CodeBehind="RatingTrendingBMPassive.aspx.vb" Inherits="GRC.Connect.Web.Charts_RatingTrendingBMPassive" %>
...
<asp:Content ID="ChartHeadContent" runat="server" ContentPlaceHolderID="ChartHeadContent">
    ...
    <script src="../../../Lib_{{VER}}/Charts/RatingTrendingBMPassive.js"></script>
    <script>
                ...
                <div class="chartContainerOutside">
                    <table cellspacing="0" cellpadding="0" style="padding: 0; border-collapse: collapse">
                        ...
                        <tr>
                            ...
                            <td class="chartContainer"><div data-bind="attr: { id: 'chartMech' + $index() }"></div></td>
                            <td class="chartContainer"><div data-bind="attr: { id: 'chartElec' + $index() }"></div></td>
                            <td class="chartContainer"><div data-bind="attr: { id: 'chartPressure' + $index() }"></div></td>
                            <td class="chartContainer"><div data-bind="attr: { id: 'chartProduction' + $index() }"></div></td>
                            <td class="chartContainer"><div data-bind="attr: { id: 'chartOccupancy' + $index() }"></div></td>
                            <td class="chartContainer"><div data-bind="attr: { id: 'chartComputer' + $index() }"></div></td>
                        </tr>
                        <!-- /ko -->
                    </table>
                </div>            
