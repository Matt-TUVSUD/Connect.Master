<%@ Page Language="vb"  MasterPageFile="~/Home_{{VER}}/Charts/ChartMasterPageRecommendations.master" AutoEventWireup="false" CodeBehind="RatingTrendingBMActive.aspx.vb" Inherits="GRC.Connect.Web.Charts_RatingTrendingBMActive" %>
...
<asp:Content ID="ChartHeadContent" runat="server" ContentPlaceHolderID="ChartHeadContent">
    ...
    <script src="../../../Lib_{{VER}}/Charts/RatingTrendingBMActive.js"></script>
    <script>
                    ...
                    <table cellspacing="0" cellpadding="0" style="padding: 0; border-collapse: collapse">
                        <tr>
                            ...
                            <td class="chartHeaderContainer headerActive">
                                Mechanical Prev. / Pred. Maintenance
                            </td>
                            <td class="chartHeaderContainer headerActive">
                                Electrical Prev. / Pred. Maintenance
                            </td>
                            <td class="chartHeaderContainer headerActive">
                                Critical Spares
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="chartContainer"><div data-bind="attr: { id: 'chartSpares' + $index() }"></div></td>
