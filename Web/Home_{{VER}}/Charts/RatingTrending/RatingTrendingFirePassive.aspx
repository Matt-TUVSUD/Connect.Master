<%@ Page Language="vb"  MasterPageFile="~/Home_{{VER}}/Charts/ChartMasterPageRecommendations.master" AutoEventWireup="false" CodeBehind="RatingTrendingFirePassive.aspx.vb" Inherits="GRC.Connect.Web.Charts_RatingTrendingFirePassive" %>
...
<asp:Content ID="ChartHeadContent" runat="server" ContentPlaceHolderID="ChartHeadContent">
    ...
    <script src="../../../Lib_{{VER}}/Charts/RatingTrendingFirePassive.js"></script>
    <script>
...
<asp:Content ID="ChartContent" runat="server" ContentPlaceHolderID="ChartContent">
    <div id="viewChart" style="display:flex; justify-content:center; align-items:center; flex-direction:column; width:100%; max-width:1775px;">
                ...
                <div class="chartContainerOutside">
                    <table cellspacing="0" cellpadding="0" style="padding: 0; border-collapse: collapse">
                        <tr>
                            ...
                            <td class="chartHeaderContainer headerPassive">
                                Flood
                            </td>
                            <td class="chartHeaderContainer headerPassive">
                                Earthquake
                        ...
                        <tr>
                            ...
                            <td class="chartContainer"><div data-bind="attr: { id: 'chartFlood' + $index() }"></div></td>
                            <td class="chartContainer"><div data-bind="attr: { id: 'chartEarthquake' + $index() }"></div></td>
                            <td class="chartContainer"><div data-bind="attr: { id: 'chartWind' + $index() }"></div></td>
                            <td class="chartContainer"><div data-bind="attr: { id: 'chartConstruction' + $index() }"></div></td>
                            <td class="chartContainer"><div data-bind="attr: { id: 'chartOccupancy' + $index() }"></div></td>
                            <td class="chartContainer"><div data-bind="attr: { id: 'chartOtherExposure' + $index() }"></div></td>
