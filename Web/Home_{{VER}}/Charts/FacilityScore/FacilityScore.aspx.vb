...
Public Class Charts_FacilityScore
    ...
    Private Sub loadDefaults()
        ...
        Try
            If Not Request.QueryString("batchSetId") Is Nothing Then
                ...
                ServerSide_ClientFeatures = razor.TblClients.LoadByPrimaryKey(BatchLib.BatchSet.Load(zBatchSetId).colFldFilePrefix).colFeatures
    ...
    Private Sub loadData()
        ...
        Try
            ...
            If Not Request.QueryString("batchSetId") Is Nothing Then
                ...
                zChartData = zChart.GetChartData(zBatchSetId)
