...
Partial Class Grids_GridMasterPagePreferences
...
#Region "Page"
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Init
        ...
        'SAID Checker
        If UtilSAID.IsNotSecureWithCookie(UtilGSafe.GetValue(zSafeGUID, UtilGSafe.KeyName.SafeGUID), zSafeGUID, Me.Page) Then
            Response.Redirect("~/Home_{{VER}}/Auth/Resecure.aspx", False)
        End If
