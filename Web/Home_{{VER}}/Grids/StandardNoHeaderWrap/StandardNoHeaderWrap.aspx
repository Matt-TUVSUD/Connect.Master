<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Home_{{VER}}/Grids/GridMasterPage.master" CodeBehind="StandardNoHeaderWrap.aspx.vb" Inherits="GRC.Connect.Web.Grids_StandardNoHeaderWrap" %>
...
<asp:Content ID="GridBodyContent" ContentPlaceHolderID="GridBodyContent" runat="server">
    <div id="viewGrid">
        ...
        <%--<div id="divContainerLoadingMap" class="containerLoading" style="display: none;"></div>--%>
            ...
            <div class="containerFormStretch">
                ...
                <div>
                    ...
                    <div id="gridStandardContainer">
                        <div id="gridStandard" class="gridStandardNoHeaderWrap"></div>
                    </div>
                </div>
                <br style="clear: both;" />
            </div>
