<%@ Page Title="Recommendation Response | Global Risk Consultants" Language="vb" AutoEventWireup="false" MasterPageFile="~/RecResponse_{{VER}}/ClientConnectRecResponse.Master" CodeBehind="rectracking.aspx.vb" Inherits="GRC.Connect.Web.rectracking_nathaz_recresponse" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Lib_{{VER}}/Generated/ViewCCLocationListingRecResponseNH.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Custom/ViewCCLocationListingRecResponseNH.js" type="text/javascript"></script>
     <script src="../../Lib_{{VER}}/Generated/NHRecommendations.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="tableDiv" style="width: 100%;">
        ...
        <div data-bind="visible: $parent.enableMgmtFields" class="tabRow">
            <span class="bufferLeft" style="height: 5px;"></span>
            <span class="" style="height: 5px; width: 782px;"></span> 
            <span class="bufferRight" style="height: 5px;"></span>
        </div>
        ...
        <div class="tabRow">
            ...
            <span class="buttonCellRecord">
                <div class="buttonContainer">
                    ...
                    <span><button data-bind="click: $parent.onNext, enable: $parent.enableNext" class="k-button buttonShape" id="btnNext"><i class="fas fa-caret-rigth"></i></button></span>
        ...
        <div class="tabRow">
            ...
            <span class="recResponse_DocumentLink" style="height: 24px;">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink recResponse_DocumentLink" style="line-height: normal;">
                    <label class="linkPointer" data-bind="visible: $parent.ToNHReport, text: $parent.objLanguageLabels().lblClickHere, click: function(data) { $parent.onBuildLink($parent.ToNHReport()) }"></label>
                </span>
            </span>
            ...
            <span class="recResponse_DocumentLink" style="height: 24px;">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink recResponse_DocumentLink" style="line-height: normal;">
                    <label class="linkPointer" data-bind="visible: $parent.ToNHDiagram, text: $parent.objLanguageLabels().lblClickHere, click: function(data) { $parent.onBuildLink($parent.ToNHDiagram()) }"></label>
                </span>
            </span>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var view = {
            ...
            clientFeatures: ko.observable("<%= ServerSide_ClientFeatures %>"),
            ToNHReport: ko.observable("<%= ServerSide_ToNHReport%>"),
            ToNHDiagram: ko.observable("<%= ServerSide_ToNHDiagram%>"),
            ...
            collListing: new es.objects.ViewCCLocationListingRecResponseNHCollection(),
            collCounts: new es.objects.ViewCCNHRecommendationCountsCollection(),
            ...
            loadCounts: function () {
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view.collCounts.GetRecommendationCountsNatHaz(view.fileNo)) {
            ...
            loadOneFileNumber: function () {
                ...
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view.collListing.GetRecResponseNHLocationByFileNo(tempParm)) { view.stateLoadError = false } else { view.stateLoadError = true }
                view.stateListingLoadOneRecord = false;

                tempParm = view.fileNo + "|" + tempHemisphere + "|one";
                es.dataProvider.baseURL = SITEBASEURL + DATASERVERENDPOINT;
                if (!view.collRec.GetRecByFileNo(tempParm)) { view.stateLoadError = false } else { view.stateLoadError = true }
                view.stateDetailsLoadOneRecord = false;
                view.stateOnlyOneDetailRecordLoaded = true;
