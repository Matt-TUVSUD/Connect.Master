<%@ Page Title="Rec. Response Grid | Global Risk Consultants" Language="vb" AutoEventWireup="false" MasterPageFile="~/RecResponse_{{VER}}/ClientConnectRecResponse.Master" CodeBehind="recdatasheetfeaturesL.aspx.vb" Inherits="GRC.Connect.Web.recdatasheetfeaturesL_nathaz_recresponse" %>
    ...
    $(document).ready(function () {
        ...
        var view = {
            ...
            loadFileNumber: function () {
                ...
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view.collListing.GetRecResponseNHLocationByFileNo(tempParm + "|" + tempHemisphere)) {
                    
                    es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                    if (!view.collRec.GetNHRecommendationGridByFileNo(tempParm + "|" + tempHemisphere)) {
