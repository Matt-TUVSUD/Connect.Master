...
Public Class rectracking_infrared_recresponse
    ...
    Public ServerSide_ToIRReport As String = ""
    Public ServerSide_ToIRDiagram As String = ""
    ...
    Private Sub loadData()
        ...
        Dim zObjListing As New ViewCCLocationListingIR
        ...
        If zObjListing.Load(zQryListing) Then
            ServerSide_ToIRReport = Replace(zObjListing.ToIRReport, "\", "\\")
            ServerSide_ToIRDiagram = ""
        End If
