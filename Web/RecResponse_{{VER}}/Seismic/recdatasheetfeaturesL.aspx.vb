...
Public Class recdatasheetfeaturesL_seismic_recresponse
    ...
    Private Sub loadData()
        ...
        Dim zObjListing As New ViewCCLocationListingNatHaz
        Dim zQryListing As New ViewCCLocationListingNatHazQuery
        zQryListing.Select()
        zQryListing.es.Top = 1
        zQryListing.Where(zQryListing.FileNo = zFileNo)
        If zObjListing.Load(zQryListing) Then
            ServerSide_ToFireReport = Replace(zObjListing.ToNatHazSeismicReport, "\", "\\")
            ServerSide_ToFireDiagram = Replace(zObjListing.ToNatHazSeismicDiagram, "\", "\\")
        End If
