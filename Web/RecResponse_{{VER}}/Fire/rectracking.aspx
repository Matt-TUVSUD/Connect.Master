<%@ Page Title="Recommendation Response | Global Risk Consultants" Language="vb" AutoEventWireup="false" MasterPageFile="~/RecResponse_{{VER}}/ClientConnectRecResponse.Master" CodeBehind="rectracking.aspx.vb" Inherits="GRC.Connect.Web.rectracking_fire_recresponse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="tableDiv" style="width: 100%;">
        <div class="tabRow" style="margin-top:10px; height:30px;">
        ...
        <div class="tabRow" style="height:30px;">
            ...
            <span class="recInputDateSmall" data-bind=""><input data-bind="style: { background: $parent.objRec().ExpectedCompletionDateColor }" id="ExpectedCompletionDate" class="k-autocomplete k-input inputCenter inputNoEdit recInputDateSmall" /></span>
    ...
    $(document).ready(function () {
        ...
        var viewMaster = {
            ...
            onCloseLanguageSelector: function () {
                ...
                $("#windowRecReview").prev().find(".k-window-title").html("<img src='../../Home_{{VER}}/images/icons/reports/document_information_24x24.png' align='left' alt='Information Icon' class='windowIcon'/>  " + viewMaster.objLanguageLabels().lblWindowRecReview_Title);
                $("#windowRecEdit").prev().find(".k-window-title").html("<img src='../../Home_{{VER}}/images/icons/reports/document_information_24x24.png' align='left' alt='Information Icon' class='windowIcon'/>  " + viewMaster.objLanguageLabels().lblWindowRecEdit_Title);
                $("#windowRecRecentSave").prev().find(".k-window-title").html("<img src='../../Home_{{VER}}/images/icons/reports/document_information_24x24.png' align='left' alt='Information Icon' class='windowIcon'/>  " + viewMaster.objLanguageLabels().lblWindowRecRecentSave_Title);
            }
        };
        ...
        var view = {
            ...
            ExpectedCompletionDateColor: ko.observable(),
            ...
            resetPickers: function () {
                ...
                if (view.clientFeatures().search("!") > -1) {
                    //if (view.objRec().ThirdLevelRespAction() == undefined) {
                    //    //view.widgetIntendedActionThirdLevel().value("");
                    //    //objRec().ThirdLevelRespAction
                    //} else {
                    //    view.widgetIntendedActionThirdLevel().value(view.objRec().ThirdLevelRespAction());
                    //}
            ...
            setCancelObject: function () {
                ...
                if (view.objRec().ThirdLevelRespDate() == undefined) { objCancel.ThirdLevelRespDate = " "; } else { objCancel.ThirdLevelRespDate = view.objRec().ThirdLevelRespDate() }
            ...
            onEnablePickers: function () {
                ...
                if (view.enablePickers()) {
                    ...
                    //    lvl3RespDate.wrapper.find(".k-icon").show();

                    //    ThirdLevelRespAction.find(".k-icon").removeClass("noedit").addClass("editRequired");
                    //    ThirdLevelRespAction.find(".k-dropdown-wrap").removeClass("noedit").addClass("editRequired");
                    //    ThirdLevelRespAction.find(".k-icon").show();
                    ...
                    if (view.objRec().IntendedAction().toLowerCase() != "completed") {
                        ...
                        if ((!view.recentlySaved) && !(ResponseDate.value() == undefined || ResponseDate.value() == "" || ResponseDate.value() == null)) {
                            if (view.editState()) { //// IF IN EDIT MODE DO NOT "REVIEW PREVIOUS RESPONSE"
                                ...
                                //// CHECK FOR "EDIT PREVIOUS RESPONSE"
                                todaysDate = new Date();
                                if ((ExpectedCompletionDate.value() !== undefined && ExpectedCompletionDate.value() !== null) && (ExpectedCompletionDate.value() < todaysDate) && (!view.previouslyWarnedEdit)) { // IF NOT NULL
                                    returnValue = false;
                                    view.previouslyWarnedEdit = true;
                                    if (!view.ignorePopups) {
                                        windowRecEdit.data("kendoWindow").open();
                                ...
                                //// CHECK FOR "REVIEW PREVIOUS RESPONSE"
                                else if ((ResponseDate.value() < StatusDate.value()) && (ExpectedCompletionDate.value() > todaysDate || ExpectedCompletionDate.value() == undefined || ExpectedCompletionDate.value() == "" || ExpectedCompletionDate.value() == null) && (!view.previouslyWarnedReview)) {
                                    returnValue = false;
                                    view.previouslyWarnedReview = true;
                                    if (!view.ignorePopups) {
                                        windowRecReview.data("kendoWindow").open();
            ...
            loadCounts: function () {
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view.collCounts.GetRecommendationCountsFire(view.fileNo)) {
            ...
            loadDetailsOnly: function () {
                ...
                if (view.stateDetailsLoadOneRecord == true && view.stateLoadError == false) {
                    if (!view.collRec.GetLocationLevelFireRecommendations(tempParm + "|" + tempHemisphere + "|one|true")) { view.stateLoadError = false } else { view.stateLoadError = true }
                    view.stateDetailsLoadOneRecord = false;
                    view.stateOnlyOneDetailRecordLoaded = true;
                } else {
                    if (!view.collRec.GetLocationLevelFireRecommendations(tempParm + "|" + tempHemisphere + "|all|true")) { view.stateLoadError = false } else { view.stateLoadError = true }
                    view.stateDetailsLoadOneRecord = false;
            ...
            loadOneFileNumber: function () {
                ...
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view.collListing.GetRecResponseFireLocationByFileNo(tempParm)) { view.stateLoadError = false } else { view.stateLoadError = true }
                view.stateListingLoadOneRecord = false;

                tempParm = view.fileNo + "|" + tempHemisphere + "|one|true";
                es.dataProvider.baseURL = SITEBASEURL + RESTSERVERENDPOINT;
                if (!view.collRec.GetLocationLevelFireRecommendations(tempParm)) { view.stateLoadError = false } else { view.stateLoadError = true }
                view.stateDetailsLoadOneRecord = false;
                view.stateOnlyOneDetailRecordLoaded = true;
            ...
            loadFileNumber: function () {
                ...
                tempParm = view.fileNo + "|" + tempHemisphere + "|all|true";
                es.dataProvider.baseURL = SITEBASEURL + RESTSERVERENDPOINT;
                if (!view.collRec.GetLocationLevelFireRecommendations(tempParm)) { view.stateLoadError = false } else { view.stateLoadError = true }
                view.stateDetailsLoadOneRecord = false;
                view.stateOnlyOneDetailRecordLoaded = false;
            ...
            onSave: function () {
                ...
                objTempRRLog.ResponseLastActivity(today);  //THIS WILL BE OVERWRITTEN ON THE SERVER TO SAVE THE DATE AS EASTERN STANDARD TIME
                es.dataProvider.baseURL = SITEBASEURL + DATASERVERENDPOINT;
                objTempRRLog.save();
        ...
        $("#windowRecReview").prev().find(".k-window-title").append("<img src='../../Home_{{VER}}/images/icons/reports/document_information_24x24.png' align='left' alt='Information Icon' class='windowIcon'/>  " + view.objLanguageLabels().lblWindowRecReview_Title);
        ...
        $("#windowRecEdit").prev().find(".k-window-title").append("<img src='../../Home_{{VER}}/images/icons/reports/document_information_24x24.png' align='left' alt='Information Icon' class='windowIcon'/>  " + view.objLanguageLabels().lblWindowRecEdit_Title);
        ...
        $("#windowRecRecentSave").prev().find(".k-window-title").append("<img src='../../Home_{{VER}}/images/icons/reports/document_information_24x24.png' align='left' alt='Information Icon' class='windowIcon'/>  " + view.objLanguageLabels().lblWindowRecRecentSave_Title);
