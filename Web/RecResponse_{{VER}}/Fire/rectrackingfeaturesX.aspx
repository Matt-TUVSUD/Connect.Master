<%@ Page Title="Recommendation Response | Global Risk Consultants" Language="vb" AutoEventWireup="false" MasterPageFile="~/RecResponse_{{VER}}/ClientConnectRecResponse.Master" CodeBehind="rectrackingfeaturesX.aspx.vb" Inherits="GRC.Connect.Web.rectrackingfeaturesX_fire_recresponse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="tableDiv" style="width: 100%;">
        ...
        <div class="tabRow">
            ...
            <span class="recLabelRecCode" style="height: 21px;"><label class="recLabelVerticalCenter" data-bind="text: $parent.objLanguageLabels().lblRecCode">Code</label></span>
            <span class="recInputRecCode" style="height: 21px;"><input data-bind="value: $parent.objRec().RecCode, attr: { title: $parent.objRec().RecCode }" id="RecCode" class="k-autocomplete k-input inputNoEdit inputLeft recInputRecCode" readonly="readonly" /></span>
            <span class="recLabelRecSmall" style="height: 21px; padding-left: 16px;"><label class="recLabelVerticalCenter" data-bind="text: $parent.objLanguageLabels().lblRecImpact">Rec. Impact</label></span>
            ...
            <span class="recInputRecStatus" id="" style="height: 21px;">
                <input data-bind="value: $parent.widgetRecStatusPlaceHolder, attr: { title: $parent.widgetRecStatusPlaceHolder }" id="RecStatus" class="k-autocomplete k-input inputNoEdit inputLeft recInputRecStatus" style="margin-left: 2px;" readonly="readonly" />
            ...
            <span class="recLabelRecSmall" style="padding-left: 9px; height: 21px;"><label class="recLabelVerticalCenter" data-bind="text: $parent.objLanguageLabels().lblStatusDate">Status Date</label></span>
            <span class="recInputDate" style="height: 21px; border: none !important;"><input data-bind="" id="StatusDate" class="k-autocomplete k-input inputCenter inputNoEdit recInputDate" readonly="readonly" /></span>
    ...
    $(document).ready(function () {
        ...
        var view = {
            ...
            onDatasheetView: function () {
                ...
                view.intendedAction = "";
                var tempURL = "";
                tempURL = "recdatasheetfeaturesX.aspx?f1=" + view.fileNo + "&rec=" + view.index;
            ...
            setCancelObject: function () {
                ...
                //if (view.clientFeatures().search("\.+") > -1) {
                if ($.inArray('\+', view.clientFeatures()) > -1) {
                    if (view.objRec().MgmtRespDate() == undefined) { objCancel.MgmtRespDate = " "; } else { objCancel.MgmtRespDate = view.objRec().MgmtRespDate(); }
        ...
        ExpectedCompletionDate.wrapper
            .find(".k-picker-wrap").addClass("expand-padding recInputDateSmall").css({"height": "14px", "margin-top": "-1px"})
            .find(".k-select").css("height", "14px").css("border", "none")
            .find(".k-icon").css("height", "12px").css("margin-top", "-2px");
