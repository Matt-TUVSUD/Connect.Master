...
Public Class recdatasheetfeaturesL_flood_recresponse
    ...
    Private Sub loadData()
        ...
        If zObjListing.Load(zQryListing) Then
            ServerSide_ToFireReport = Replace(zObjListing.ToNatHazFloodReport, "\", "\\")
            ServerSide_ToFireDiagram = Replace(zObjListing.ToNatHazFloodDiagram, "\", "\\")
        End If
