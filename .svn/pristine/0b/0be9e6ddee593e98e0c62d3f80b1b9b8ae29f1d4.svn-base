...
// Date Generated       : 4/27/2018 10:56:45 AM
//===============================================================================
...
(function (es) { //myNS = "myNameSpace" ... for example purposes
	...
	es.objects.ViewCCLocationInspectionPS = es.defineEntity(function () {
	...
	es.objects.ViewCCLocationInspectionPS.prototype.esTypeDefs = {};

	es.objects.ViewCCLocationInspectionPS.prototype.esRoutes = {
		commit: { method: 'PUT', url: 'ViewCCLocationInspectionPS_Save', response: 'entity' }
	};

	es.objects.ViewCCLocationInspectionPS.prototype.esColumnMap = {
		'FileNo': 1,
		'FilePrefix': 1,
		'PracticeCode': 1,
		'Engineer': 1,
...
(function (es) {
	...
	es.objects.ViewCCLocationInspectionPSCollection = es.defineCollection('ViewCCLocationInspectionPSCollection', 'ViewCCLocationInspectionPS');

	//#region Prototype Level Information

	es.objects.ViewCCLocationInspectionPSCollection.prototype.esRoutes = {
		commit: { method: 'PUT', url: 'ViewCCLocationInspectionPSCollection_Save', response: 'collection' },
		loadAll: { method: 'GET', url: 'ViewCCLocationInspectionPSCollection_LoadAll', response: 'collection' }
	};
