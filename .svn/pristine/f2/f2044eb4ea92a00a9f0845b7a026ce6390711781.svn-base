...
function onCommentsHide() {
    ...
    $("#windowComments").closest(".k-window").hide();
    $("#windowCommentsSuccess").closest(".k-window").hide();
    $("#windowCommentsFail").closest(".k-window").hide();
}
...
function createEmail() {
    ...
    /////////////////////////////////////////////////////
    /////////////////////////////////////////////////////
    //// DELETE THE BELOW AND UNCOMMENT THE ABOVE, THIS IS A DISABLE FOR FAILURE TO SEND EMAIL.
    //    $(txtFeedbackComments).val("Enter Comments Here");
    //    $(txtFeedbackComments).addClass("watermark_TextArea");
    //    $(txtFeedbackComments).removeAttr("disabled");
    //    $(lblCommentsPleaseWait).hide();
