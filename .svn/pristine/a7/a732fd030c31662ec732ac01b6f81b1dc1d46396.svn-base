<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tab_locationdetails.aspx.vb" Inherits="GRC.Connect.Web.tab_locationdetails_infared" %>
...
<head runat="server">
    ...
    <script src="../../Lib_{{VER}}/Generated/ViewCCLocationInspectionIR.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Generated/ViewCCLocationListingIR.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Custom/ViewCCLocationInspectionIR.js" type="text/javascript"></script>
...
<body>
    ...
    <div class="tableDiv">
        <div class="tabRow">
            ...
            <span class="documentsInputs"><input data-bind="" id="IRActualDate" class="k-autocomplete k-numerictextbox inputCenter inputNoEdit documentsInputs" readonly="true" /></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs"><input data-bind="" id="IREmailedDate" class="k-autocomplete k-numerictextbox inputCenter inputNoEdit documentsInputs" readonly="true" /></span>
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink documentsInputs" style="line-height: normal;" id="lblToReportClickHere">
                    ...
                    <label class="linkPointer" data-bind="visible: $parent.objListing().ToIRReport, text: $parent.objLanguageLabels().lblClickHere, click: function (data) { $parent.onBuildLink($parent.objListing().ToIRReport()) }"></label>
                </span>
            </span>           
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs">
                <!--<span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink k-state-disabled documentsInputs" style="line-height: normal;">
                    <label class="linkPointer" data-bind="visible: $parent.objListing().ToIRReport2, text: $parent.objLanguageLabels().lblClickHere, click: function(data) { $parent.onBuildLink($parent.objListing().ToIRReport2()) }"></label>
                </span>-->
            </span>
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs">
                <!--<span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink k-state-disabled documentsInputs" style="line-height: normal;">
                    <label class="linkPointer" data-bind="visible: $parent.objListing().ToIRDiagram, text: $parent.objLanguageLabels().lblClickHere, click: function(data) { $parent.onBuildLink($parent.objListing().ToIRDiagram()) }"></label>
                </span>-->
            </span>
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs"><input data-bind="" id="IRLastInspectionDate" class="k-autocomplete k-numerictextbox inputCenter inputNoEdit documentsInputs" readonly="true" /></span>
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink documentsInputs" style="line-height: normal;" id="lblLastInspectionReportClickHere">
                    ...
                    <label class="linkPointer" data-bind="visible: $parent.objListing().IRLastInspectionReport, text: $parent.objLanguageLabels().lblClickHere, click: function (data) { $parent.onBuildLink($parent.objListing().IRLastInspectionReport()) }"></label>
                </span>
            </span>
            <span class="borderRightGray"></span>
    ...
    <div id="windowNoLocation" class="windowContent" style="font-size:13px;">
        ...
        <div style="display:flex; justify-content: center; width:100%">
            <button class="grcBlueBtn" data-bind="text: $parent.objLanguageLabels().lblGoBackToDetails, click: $parent.onLocationDetailsRedirect">Go Back To Location Details</button></div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var view_LocationDetails = {
            ...
            collInspection: new es.objects.ViewCCLocationInspectionIRCollection(),
            ...
            resetPickers: function () {
                ...
                if (view_LocationDetails.objListing().IREmailedDate() == null || view_LocationDetails.objListing().IREmailedDate() == undefined || view_LocationDetails.objListing().IREmailedDate() == "" || view_LocationDetails.objListing().IREmailedDate() == "Mon Jan 1 00:00:00 EST 1900")
                { IREmailedDate.value(""); } else { IREmailedDate.value(view_LocationDetails.objListing().IREmailedDate()); }
                if (view_LocationDetails.objListing().IRActualDate() == null || view_LocationDetails.objListing().IRActualDate() == undefined || view_LocationDetails.objListing().IRActualDate() == "" || view_LocationDetails.objListing().IRActualDate() == "Mon Jan 1 00:00:00 EST 1900")
                { IRActualDate.value(""); } else { IRActualDate.value(view_LocationDetails.objListing().IRActualDate()); }
                ...
                if (view_LocationDetails.objListing().IRLastInspectionDate() == null || view_LocationDetails.objListing().IRLastInspectionDate() == undefined || view_LocationDetails.objListing().IRLastInspectionDate() == "" || view_LocationDetails.objListing().IRLastInspectionDate() == "Mon Jan 1 00:00:00 EST 1900")
                { IRLastInspectionDate.value(""); } else { IRLastInspectionDate.value(view_LocationDetails.objListing().IRLastInspectionDate()); }
            ...
            loadDetailsOnly: function () {
                ...
                if (view_LocationDetails.stateDetailsLoadOneRecord == true && view_LocationDetails.stateLoadError == false) {
                    if (!view_LocationDetails.collInspection.ViewCCLocationInspectionIRCollections(tempParm + "|one")) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                    view_LocationDetails.stateDetailsLoadOneRecord = false;
                    view_LocationDetails.stateOnlyOneDetailRecordLoaded = true;
                } else {
                    if (!view_LocationDetails.collInspection.ViewCCLocationInspectionIRCollections(tempParm + "|all")) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                    view_LocationDetails.stateDetailsLoadOneRecord = false;
            ...
            loadOneFileNumber: function () {
                ...
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view_LocationDetails.collListing.ViewCCLocationIRCollections(tempParm)) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                view_LocationDetails.stateListingLoadOneRecord = false;

                tempParm = view_LocationDetails.gSafeGuid + "|one";
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view_LocationDetails.collInspection.ViewCCLocationInspectionIRCollections(tempParm)) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                view_LocationDetails.stateDetailsLoadOneRecord = false;
                view_LocationDetails.stateOnlyOneDetailRecordLoaded = true;
            ...
            loadFileNumber: function () {
                ...
                //                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                //                if (!view_LocationDetails.collListing.ViewCCLocationIRCollections(tempParm)) {
                //                    es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                //                    if (!view_LocationDetails.collInspection.ViewCCLocationInspectionIRCollections(view_LocationDetails.gSafeGuid)) {
                //                        view_LocationDetails.objListing(view_LocationDetails.collListing()[0]);
                //                        view_LocationDetails.objInspection(view_LocationDetails.collInspection()[0]);
                //                        view_LocationDetails.clientFeatures(getClientFeatures(view_LocationDetails.gSafeGuid));
                //                        view_LocationDetails.objFind(getFindLocationFields(view_LocationDetails.gSafeGuid));
        ...
        var IREmailedDate = $("#IREmailedDate").kendoDatePicker({
            value: view_LocationDetails.objListing().IREmailedDate(),
            format: "dd-MMM-yy"
        }).data("kendoDatePicker");
        IREmailedDate.wrapper
            .find(".k-picker-wrap").addClass("expand-padding").css("height", "13px").css("width", "113px").find(".k-select").hide();

        var IRActualDate = $("#IRActualDate").kendoDatePicker({
            value: view_LocationDetails.objListing().IRActualDate(),
            format: "dd-MMM-yy"
        }).data("kendoDatePicker");
        IRActualDate.wrapper
            .find(".k-picker-wrap").addClass("expand-padding").css("height", "13px").css("width", "113px").find(".k-select").hide();
        ...
        var IRLastInspectionDate = $("#IRLastInspectionDate").kendoDatePicker({
            value: view_LocationDetails.objListing().IRLastInspectionDate(),
            format: "dd-MMM-yy"
        }).data("kendoDatePicker");
        IRLastInspectionDate.wrapper
            .find(".k-picker-wrap").addClass("expand-padding").css("height", "13px").css("width", "113px").find(".k-select").hide();
