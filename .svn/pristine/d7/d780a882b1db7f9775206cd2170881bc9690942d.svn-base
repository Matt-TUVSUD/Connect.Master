...
Public Class BmCopeDataReport_PrimaryTransformers
    ...
    Private Function GetDataSource() As DataTable
        ...
        Dim zCmd As New SqlClient.SqlCommand("SELECT * FROM rv.vwBMCopeElecTransformer WHERE filePrefix='" & rptProperties.FilePrefix & "'", zCon)
    ...
    End Function
     ...
     Private Sub BmCopeDataReport_PrimaryTransformers_NeedDataSource(sender As Object, e As System.EventArgs) Handles Me.NeedDataSource
        Me.DataSource = GetDataSource() 'ReportQuery.SubQueries.BoilerFacilityData_PrimaryTransformers
     End Sub
