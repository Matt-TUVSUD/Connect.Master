...
//    var cell0201Config = {
//        interval: 300,
//        over: function (event) { zoomIn("#cell0201", 2, "left", "middle", "-220px", "520px"); cell0201TreeView.expand(".k-item"); },
//        out: function (event) { zoomOut("#cell0201", "120px"); cell0201TreeView.collapse(".k-item"); }
//    };
//    $("#cell0201").hoverIntent(cell0201Config);

//    var cell0202Config = {
//        interval: 300,
//        over: function (event) { zoomIn("#cell0202", 2, "middle", "middle", "-220px", "520px"); cell0202TreeView.expand(".k-item"); },
//        out: function (event) { zoomOut("#cell0202", "120px"); cell0202TreeView.collapse(".k-item"); }
//    };
//    $("#cell0202").hoverIntent(cell0202Config);

//    var cell0203Config = {
//        interval: 300,
//        over: function (event) { zoomIn("#cell0203", 2, "middle", "middle", "-220px", "520px"); cell0203TreeView.expand(".k-item"); },
//        out: function (event) { zoomOut("#cell0203", "120px"); cell0203TreeView.collapse(".k-item"); }
//    };
//    $("#cell0203").hoverIntent(cell0203Config);

//    var cell0204Config = {
//        interval: 300,
//        over: function (event) { zoomIn("#cell0204", 2, "middle", "middle", "-220px", "520px"); cell0204TreeView.expand(".k-item"); },
//        out: function (event) { zoomOut("#cell0204", "120px"); cell0204TreeView.collapse(".k-item"); }
//    };
//    $("#cell0204").hoverIntent(cell0204Config);

//    var cell0205Config = {
//        interval: 300,
//        over: function (event) { zoomIn("#cell0205", 2, "middle", "middle", "-220px", "520px"); cell0205TreeView.expand(".k-item"); },
//        out: function (event) { zoomOut("#cell0205", "120px"); cell0205TreeView.collapse(".k-item"); }
//    };
...
//        out: function (event) { zoomOut("#cell0206", "120px"); cell0206TreeView.collapse(".k-item"); }
//    };
//    $("#cell0206").hoverIntent(cell0206Config);

//    var cell0207Config = {
//        interval: 300,
//        over: function (event) { zoomIn("#cell0207", 2, "middle", "middle", "-220px", "520px"); cell0207TreeView.expand(".k-item"); },
//        out: function (event) { zoomOut("#cell0207", "120px"); cell0207TreeView.collapse(".k-item"); }
//    };
//    $("#cell0207").hoverIntent(cell0207Config);

//    var cell0208Config = {
//        interval: 300,
//        over: function (event) { zoomIn("#cell0208", 2, "right", "middle", "-220px", "520px"); cell0208TreeView.expand(".k-item"); },
//        out: function (event) { zoomOut("#cell0208", "120px"); cell0208TreeView.collapse(".k-item"); }
//    };
...
//    var cell0301Config = {
//        interval: 300,
//        over: function (event) { zoomIn("#cell0301", 3, "left", "top", "0px", "425px"); cell0301TreeView.expand(".k-item"); },
//        out: function (event) { zoomOut("#cell0301", "140px"); cell0301TreeView.collapse(".k-item"); }
//    };
//    $("#cell0301").hoverIntent(cell0301Config);

    var cell0302Config = {
        interval: 300,
        over: function (event) { zoomIn("#cell0302", 3, "left", "top", "0px", "425px"); cell0302TreeView.expand(".k-item"); },
        out: function (event) { zoomOut("#cell0302", "140px"); cell0302TreeView.collapse(".k-item"); }
    };
    $("#cell0302").hoverIntent(cell0302Config);

    var cell0303Config = {
        interval: 300,
        over: function (event) { zoomIn("#cell0303", 3, "middle", "top", "0px", "425px"); cell0303TreeView.expand(".k-item"); },
        out: function (event) { zoomOut("#cell0303", "140px"); cell0303TreeView.collapse(".k-item"); }
    };
    $("#cell0303").hoverIntent(cell0303Config);

    var cell0304Config = {
        interval: 300,
        over: function (event) { zoomIn("#cell0304", 3, "middle", "top", "0px", "425px"); cell0304TreeView.expand(".k-item"); },
        out: function (event) { zoomOut("#cell0304", "140px"); cell0304TreeView.collapse(".k-item"); }
    };
    $("#cell0304").hoverIntent(cell0304Config);

    var cell0305Config = {
        interval: 300,
        over: function (event) { zoomIn("#cell0305", 3, "middle", "top", "0px", "425px"); cell0305TreeView.expand(".k-item"); },
        out: function (event) { zoomOut("#cell0305", "140px"); cell0305TreeView.collapse(".k-item"); }
    };
    $("#cell0305").hoverIntent(cell0305Config);

    var cell0306Config = {
        interval: 300,
        over: function (event) { zoomIn("#cell0306", 3, "middle", "top", "0px", "425px"); cell0306TreeView.expand(".k-item"); },
        out: function (event) { zoomOut("#cell0306", "140px"); cell0306TreeView.collapse(".k-item"); }
    };
    $("#cell0306").hoverIntent(cell0306Config);

    var cell0307Config = {
        interval: 300,
        over: function (event) { zoomIn("#cell0307", 3, "middle", "top", "0px", "425px"); cell0307TreeView.expand(".k-item"); },
        out: function (event) { zoomOut("#cell0307", "140px"); cell0307TreeView.collapse(".k-item"); }
    };
    $("#cell0307").hoverIntent(cell0307Config);

    var cell0308Config = {
        interval: 300,
        over: function (event) { zoomIn("#cell0308", 3, "right", "top", "0px", "425px"); cell0308TreeView.expand(".k-item"); },
        out: function (event) { zoomOut("#cell0308", "140px"); cell0308TreeView.collapse(".k-item"); }
    };
    ...
    function buildDataSource() {
        ...
        for (y = 0; y < collSiteMap().length; y++) {
            if (collSiteMap()[y].NavParentLinkId() != undefined && collSiteMap()[y].NavParentLinkId() == parentId) {
                ...
                if (returnCollection.length == 0) {
                    returnCollection = [{
                        ...
                        url: getNavUrl(collSiteMap()[y].NavUrl()),
            ...
            ////FORCE THE ADD OF LOCATION DETAILS WITH NO SUB ITEMS IF EXISTS
            //if (collSiteMap()[y].NavText() == "Location Details") {
            //    subMenu = buildSubMenu(collSiteMap()[y].NavLinkId());
            //    if (returnCollection.length == 0) {
            //        returnCollection = [{
            //            key: collSiteMap()[y].NavLinkId(),
            //            text: collSiteMap()[y].NavText(),
            ...
            if (NavLinkId == collSiteMap()[x].NavParentLinkId()) {
                if (returnSubMenu.length == 0) {
                    returnSubMenu = [{
                        ...
                        url: getNavUrl(collSiteMap()[x].NavUrl()),
                        navEnabled: collSiteMap()[y].NavEnabled(),
