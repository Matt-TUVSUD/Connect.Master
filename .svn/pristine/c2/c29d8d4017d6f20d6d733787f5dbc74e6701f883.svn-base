<%@ Page Title="Rec. Response Grid | Global Risk Consultants" Language="vb" AutoEventWireup="false" MasterPageFile="~/RecResponse_{{VER}}/ClientConnectRecResponse.Master" CodeBehind="recdatasheetfeaturesL.aspx.vb" Inherits="GRC.Connect.Web.recdatasheetfeaturesL_wind_recresponse" %>
        ...
        var view = {
            ...
            loadFileNumber: function () {
                ...
                if (!view.collListing.GetRecResponseNatHazLocationByFileNo(tempParm)) {
                    ...
                    es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                    if (!view.collRec.GetWindRecommendationGridByFileNo(tempParm + "|" + tempHemisphere)) {
