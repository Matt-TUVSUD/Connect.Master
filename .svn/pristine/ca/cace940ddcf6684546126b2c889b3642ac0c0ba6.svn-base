...
(function (es) { //myNS = "myNameSpace" ... for example purposes
	...
	es.objects.ViewCCLocationInspectionNH = es.defineEntity(function () {
	...
	es.objects.ViewCCLocationInspectionNH.prototype.esTypeDefs = {};

	es.objects.ViewCCLocationInspectionNH.prototype.esRoutes = {
		commit: { method: 'PUT', url: 'ViewCCLocationInspectionNH_Save', response: 'entity' }
	};

	es.objects.ViewCCLocationInspectionNH.prototype.esColumnMap = {
		'FileNo': 1,
		'FilePrefix': 1,
		'PracticeCode': 1,
		'Engineer': 1,
...
(function (es) {
	...
	es.objects.ViewCCLocationInspectionNHCollection = es.defineCollection('ViewCCLocationInspectionNHCollection', 'ViewCCLocationInspectionNH');

	//#region Prototype Level Information

	es.objects.ViewCCLocationInspectionNHCollection.prototype.esRoutes = {
		commit: { method: 'PUT', url: 'ViewCCLocationInspectionNHCollection_Save', response: 'collection' },
		loadAll: { method: 'GET', url: 'ViewCCLocationInspectionNHCollection_LoadAll', response: 'collection' }
	};
