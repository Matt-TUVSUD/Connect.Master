<%@ Page Title="Rec. Response Grid | Global Risk Consultants" Language="vb" AutoEventWireup="false" MasterPageFile="~/RecResponse_{{VER}}/ClientConnectRecResponse.Master" CodeBehind="recdatasheet.aspx.vb" Inherits="GRC.Connect.Web.recdatasheet_boiler_recresponse" %>
