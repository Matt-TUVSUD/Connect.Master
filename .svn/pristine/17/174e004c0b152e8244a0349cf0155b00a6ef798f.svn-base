...
(function (es) { //myNS = "myNameSpace" ... for example purposes
	...
	es.objects.ViewCCLocationListingRecResponseFire = es.defineEntity(function () {
	...
	es.objects.ViewCCLocationListingRecResponseFire.prototype.esTypeDefs = {};

	es.objects.ViewCCLocationListingRecResponseFire.prototype.esRoutes = {
		commit: { method: 'PUT', url: 'ViewCCLocationListingRecResponseFire_Save', response: 'entity' }
	};

	es.objects.ViewCCLocationListingRecResponseFire.prototype.esColumnMap = {
		'Client': 1,
		'PracticeCode': 1,
		'Facility': 1,
		'ClientLocNo': 1,
...
(function (es) {
	...
	es.objects.ViewCCLocationListingRecResponseFireCollection = es.defineCollection('ViewCCLocationListingRecResponseFireCollection', 'ViewCCLocationListingRecResponseFire');

	//#region Prototype Level Information

	es.objects.ViewCCLocationListingRecResponseFireCollection.prototype.esRoutes = {
		commit: { method: 'PUT', url: 'ViewCCLocationListingRecResponseFireCollection_Save', response: 'collection' },
		loadAll: { method: 'GET', url: 'ViewCCLocationListingRecResponseFireCollection_LoadAll', response: 'collection' }
	};
