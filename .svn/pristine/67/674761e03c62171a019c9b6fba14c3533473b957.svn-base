<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tab_locationdetails.aspx.vb" Inherits="GRC.Connect.Web.tab_locationdetails_diversified" %>
...
<head runat="server">
    ...
    <script src="../../Lib_{{VER}}/Generated/ViewCCLocationInspectionDiversified.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Generated/ViewCCLocationListingDiversified.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Custom/ViewCCLocationInspectionDiversified.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Custom/ViewCCLocationListingDiversified.js" type="text/javascript"></script>
</head>
<body>
    ...
    <div class="tableDiv">
        <div class="tabRow">
            ...
            <span class="documentsInputs"><input data-bind="" id="DivServActualDate" class="k-autocomplete k-numerictextbox inputCenter inputNoEdit documentsInputs" readonly="true" /></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs"><input data-bind="" id="DivServEmailedDate" class="k-autocomplete k-numerictextbox inputCenter inputNoEdit documentsInputs" readonly="true" /></span>
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink documentsInputs" style="line-height: normal;" id="lblToReportClickHere">
                    <label class="linkPointer" data-bind="visible: $parent.objListing().ToDivServReport, text: $parent.objLanguageLabels().lblClickHere, click: function (data) { $parent.onBuildLink($parent.objListing().ToDivServReport()) }"></label>
                </span>
            </span>           
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink documentsInputs" style="line-height: normal;" id="lblToDiagramClickHere">
                    <label class="linkPointer" data-bind="visible: $parent.objListing().ToDivServDiagram, text: $parent.objLanguageLabels().lblClickHere, click: function (data) { $parent.onBuildLink($parent.objListing().ToDivServDiagram()) }"></label>
                </span>
            </span>
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs"><input data-bind="" id="DivServLastInspectionDate" class="k-autocomplete k-numerictextbox inputCenter inputNoEdit documentsInputs" readonly="true" /></span>
            <span class="borderRightGray"></span>
        ...
        <div class="tabRow">
            ...
            <span class="documentsInputs">
                <span class="k-widget k-autocomplete k-header k-input inputCenter inputNoEdit inputLink documentsInputs" style="line-height: normal;" id="lblLastInspectionReportClickHere">
                    <label class="linkPointer" data-bind="visible: $parent.objListing().DivServLastInspectionReport, text: $parent.objLanguageLabels().lblClickHere, click: function (data) { $parent.onBuildLink($parent.objListing().DivServLastInspectionReport()) }"></label>
                </span>
            </span>
            <span class="borderRightGray"></span>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var dsLanguageLabels = {
            ...
            lblSearchNotFound: "This location is not active for Diversified.  Choose a different service."
        };
        ...
        var view_LocationDetails = {
            ...
            collInspection: new es.objects.ViewCCLocationInspectionDiversifiedCollection(),
            collListing: new es.objects.ViewCCLocationListingDiversifiedCollection(),
            ...
            resetPickers: function () {
                ...
                if (view_LocationDetails.objListing().DivServEmailedDate() == null || view_LocationDetails.objListing().DivServEmailedDate() == undefined || view_LocationDetails.objListing().DivServEmailedDate() == "" || view_LocationDetails.objListing().DivServEmailedDate() == "Mon Jan 1 00:00:00 EST 1900")
                { DivServEmailedDate.value(""); } else { DivServEmailedDate.value(view_LocationDetails.objListing().DivServEmailedDate()); }
                if (view_LocationDetails.objListing().DivServActualDate() == null || view_LocationDetails.objListing().DivServActualDate() == undefined || view_LocationDetails.objListing().DivServActualDate() == "" || view_LocationDetails.objListing().DivServActualDate() == "Mon Jan 1 00:00:00 EST 1900")
                { DivServActualDate.value(""); } else { DivServActualDate.value(view_LocationDetails.objListing().DivServActualDate()); }
                if (view_LocationDetails.objListing().DivServLastInspectionDate() == null || view_LocationDetails.objListing().DivServLastInspectionDate() == undefined || view_LocationDetails.objListing().DivServLastInspectionDate() == "" || view_LocationDetails.objListing().DivServLastInspectionDate() == "Mon Jan 1 00:00:00 EST 1900")
                { DivServLastInspectionDate.value(""); } else { DivServLastInspectionDate.value(view_LocationDetails.objListing().DivServLastInspectionDate()); }
            ...
            clearPickers: function (pIsIgnoreTextFields) {
                //// KENDO WIDGETS
                EngTargetMo.value("");
                DivServEmailedDate.value("");
                DivServActualDate.value("");
                EffectiveDate.value("");
                CancelDate.value("");
                DivServLastInspectionDate.value("");
                DateCompleted.value("");
                ...
                //// HTML / KNOCKOUT DOMS
                $("#ToDivServReport").hide();
                $("#ToDivServReport2").hide();
                $("#ToDivServDiagram").hide();
                $("#DivServLastInspectionReport").hide();
            ...
            loadDetailsOnly: function () {
                ...
                if (view_LocationDetails.stateDetailsLoadOneRecord == true && view_LocationDetails.stateLoadError == false) {
                    if (!view_LocationDetails.collInspection.ViewCCLocationInspectionDiversifiedCollections(tempParm + "|one")) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                    view_LocationDetails.stateDetailsLoadOneRecord = false;
                    view_LocationDetails.stateOnlyOneDetailRecordLoaded = true;
                } else {
                    if (!view_LocationDetails.collInspection.ViewCCLocationInspectionDiversifiedCollections(tempParm + "|all")) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                    view_LocationDetails.stateDetailsLoadOneRecord = false;
            ...
            loadOneFileNumber: function () {
                ...
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view_LocationDetails.collListing.ViewCCLocationDiversifiedCollections(tempParm)) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                view_LocationDetails.stateListingLoadOneRecord = false;

                tempParm = view_LocationDetails.gSafeGuid + "|one";
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view_LocationDetails.collInspection.ViewCCLocationInspectionDiversifiedCollections(tempParm)) { view_LocationDetails.stateLoadError = false } else { view_LocationDetails.stateLoadError = true }
                view_LocationDetails.stateDetailsLoadOneRecord = false;
                view_LocationDetails.stateOnlyOneDetailRecordLoaded = true;
        ...
        var DivServEmailedDate = $("#DivServEmailedDate").kendoDatePicker({
            value: view_LocationDetails.objListing().DivServEmailedDate(),
            format: "dd-MMM-yy"
        }).data("kendoDatePicker");
        DivServEmailedDate.wrapper
            .find(".k-picker-wrap").addClass("expand-padding").css("height", "13px").css("width", "113px").find(".k-select").hide();

        var DivServActualDate = $("#DivServActualDate").kendoDatePicker({
            value: view_LocationDetails.objListing().DivServActualDate(),
            format: "dd-MMM-yy"
        }).data("kendoDatePicker");
        DivServActualDate.wrapper
            .find(".k-picker-wrap").addClass("expand-padding").css("height", "13px").css("width", "113px").find(".k-select").hide();
        ...
        var DivServLastInspectionDate = $("#DivServLastInspectionDate").kendoDatePicker({
            value: view_LocationDetails.objListing().DivServLastInspectionDate(),
            format: "dd-MMM-yy"
        }).data("kendoDatePicker");
        DivServLastInspectionDate.wrapper
            .find(".k-picker-wrap").addClass("expand-padding").css("height", "13px").css("width", "113px").find(".k-select").hide();
