// STB NOTE 2/7/2017 - THIS FILE NO LONGER USED
...
//	es.objects.ViewCCLocationListingNatHaz = es.defineEntity(function () {
...
//	es.objects.ViewCCLocationListingNatHaz.prototype.esTypeDefs = {};

//	es.objects.ViewCCLocationListingNatHaz.prototype.esRoutes = {
//		commit: { method: 'PUT', url: 'ViewCCLocationListingNatHaz_Save', response: 'entity' }
//	};

//	es.objects.ViewCCLocationListingNatHaz.prototype.esColumnMap = {
//		'FileNo': 1,
//		'Client': 1,
//		'PracticeCode': 1,
//		'Report1': 1,
...
//	es.objects.ViewCCLocationListingNatHazCollection = es.defineCollection('ViewCCLocationListingNatHazCollection', 'ViewCCLocationListingNatHaz');

//	//#region Prototype Level Information

//	es.objects.ViewCCLocationListingNatHazCollection.prototype.esRoutes = {
//		commit: { method: 'PUT', url: 'ViewCCLocationListingNatHazCollection_Save', response: 'collection' },
//		loadAll: { method: 'GET', url: 'ViewCCLocationListingNatHazCollection_LoadAll', response: 'collection' }
//	};
