<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Home_{{VER}}/ClientConnectUserReclassification.Master" CodeBehind="UserReclassification.aspx.vb" Inherits="GRC.Connect.Web.UserReclassification" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <!--Link files here CSS/JS for example-->
    <script>
        gPageName = "UserReclassification"
    </script>
</asp:Content>
...
<div id="view">
    ...
    <div class="ui-helper-clearfix" style="width:800px; min-height:64px;">
        <div class="ui-helper-clearfix" style="width: 50%; float: left;" id="leftSide">
            <div class="ui-helper-clearfix infoHolder" style="height:15px;">
            ...
            <div class="ui-helper-clearfix infoHolder">
                ...
                <label class="infoLabel" style="margin-bottom:10px; font-size:10px;" data-bind="text:colAccessLevelDetails"></label>
            </div>
        </div>
        <div class="ui-helper-clearfix" id="rightSide" style="width: 50%; float: left;">
           <div class="ui-helper-clearfix infoHolder">
            ...
            <div class="ui-helper-clearfix infoHolder">
                <label class="infoLabelRight" style="margin-bottom:10px;">
    ...
    <div style="text-align:center; margin-bottom:10px; width:665px;">
        ...
        <div id="windowDefinitions" style="display:none;">
            ...
            <div class="ui-helper-clearfix defRow">
                <span class="defLbl"><strong>Report Email</strong></span><span class="def">Email confirmation once the auto-rec recipient makes any changes.</span>
            </div>
            <div class="ui-helper-clearfix defRow">
                <span style="padding-top:10px;" class="defLbl"><strong>1st Follow-Up</strong></span><span class="def">1st follow-up email sent to remind auto-rec recipient to complete responses.</span>
            </div>
            <div class="ui-helper-clearfix defRow">
                <span style="padding-top:10px;" class="defLbl"><strong>2nd Follow-Up</strong></span><span class="def">2nd follow-up email sent to remind auto-rec recipient to complete responses.</span>
            </div>
            <div class="ui-helper-clearfix defRow">
                <span style="padding-top:10px;" class="defLbl"><strong>3rd Follow-Up</strong></span><span class="def">3rd and final follow-up email sent to remind auto-rec recipient to complete responses.</span>
            </div>
            <div class="ui-helper-clearfix defRow">
                <span style="padding-top:15px;" class="defLbl"><strong>Exp'd Follow-Up</strong></span><span class="def">Email to auto-rec recipient identifying that there are recomendations where the Expected Complete Data is about to expire, has expired, or is blank.</span>
            </div>
            <div class="ui-helper-clearfix defRow">
                <span style="padding-top:10px;" class="defLbl"><strong>1st Overdue</strong></span><span class="def">Monthly management email identifying all facilities who have received the 1st follow-up and responses are still outstanding.</span>
            </div>
            <div class="ui-helper-clearfix defRow">
            ...
            <div class="ui-helper-clearfix defRow">
                <span style="padding-top:10px;" class="defLbl"><strong>3rd Overdue</strong></span><span class="def">Monthly management email identifying all facilities who have received the 3rd and final follow-up and responses are still outstanding.</span>
            </div>
            <div class="ui-helper-clearfix defRow">
                <span class="defLbl pastDue"><strong>Exp'd Over- due</strong></span><span class="def">Monthly management email identifying all facilities where there is at least one recommendation with an expected completion date that is now overdue.</span>
            </div>
        </div>
    </div>
    <div id="gridHldr" style="margin-bottom:10px;">
    ...
    <div id="RadioHldr" class="ui-helper-clearfix" style="margin-bottom:10px; margin-left:50px;">
        ...
        <input data-bind="checked: colActionId, attr: { value: radValueConfirm }, click: onActionClick" type="radio" id="confirm" /><label id="lblRadConfirm" for="confirm">Confirm User</label>
        <a href="#" data-bind="click: function () { onClearSelection(true); }" style="margin-left:10px;">Clear Selection</a>
    </div>
    <div class="ui-helper-clearfix">
        <div id="actionLinkHldr" style="float:left; width:30%; margin-top:20px;">
            <a href="#" id="btnPendingOnly" style="text-decoration:underline; cursor:pointer; margin-bottom:5px; float:left; width:100%;" data-bind="click: onPendingMode, text: txtButtonPendingOnly">Back</a>
            ...
            <%--<a href="#" style="text-decoration:underline; cursor:pointer; margin-bottom:15px; float:left; width:100%;">Clear Pending Filter</a>--%>
            
        </div>
        <div id="noteHldr" style="text-align:center; float:left; width:44%;">
            <span data-bind="text: txtReclassStatus"></span>
        </div>
    </div>
    <div id="btnHldr" class="ui-helper-clearfix" style="text-align:center; margin-bottom:10px; position:relative;">
    ...
    <div id="countHldr" style="height:22px;">
        <div id="numRecordHolder" style="text-align: center; margin-bottom: 10px; width: 655px;">
            <label style="font-size: 18px;"><strong>Record <span data-bind="text: colUserIndex"></span> of <span data-bind="text: colUserTotalCount"></span> - <span data-bind="text: userTotalCountPending"></span> Remaining</strong></label>
        </div>
        <div id="numPendingRecordHolder" style="text-align: center; margin-bottom: 10px; width: 655px; display: none;">
            <label style="font-size: 18px;"><strong>Record <span data-bind="text: colUserIndex"></span> of <span data-bind="text: colUserTotalCount"></span> Remaining</strong></label>
        </div>
    </div>
    <div id="divMessageComplete" style="position:relative;">
        <p style="color:#ff0000; font-weight:700;">You have authenticated all users! Please click the Exit button to complete the process.</p>
        <button id="btnExit" style="background:#ff0000; color:#000; border:1px solid #ed7d31; position:absolute; bottom:-6px; right:11px; height:25px; width:45px;" data-bind="click: onExit">Exit</button>
    </div>
