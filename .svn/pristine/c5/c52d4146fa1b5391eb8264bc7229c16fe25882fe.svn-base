...
Namespace razor
    Partial Public Class VwClientUsers

        Public Shared Function LoadData() As List(Of rowVwClientUsers)
            Return LoadData(New SqlClient.SqlCommand(), Nothing, Nothing)
        End Function

        Public Shared Function LoadData(pLoadEventUserState As Object) As List(Of rowVwClientUsers)
            Return LoadData(New SqlClient.SqlCommand(), Nothing, pLoadEventUserState)
        End Function

        Public Shared Function LoadData(pSQL As String) As List(Of rowVwClientUsers)
            Dim zCmd As New SqlClient.SqlCommand(pSQL)
            Return LoadData(zCmd, Nothing, Nothing)
        End Function

        Public Shared Function LoadData(pSQL As String, ByRef pTransaction As SqlClient.SqlTransaction) As List(Of rowVwClientUsers)
            Dim zCmd As New SqlClient.SqlCommand(pSQL)
            Return LoadData(zCmd, pTransaction, Nothing)
        End Function

        Public Shared Function LoadData(pSQL As String, ByRef pTransaction As SqlClient.SqlTransaction, pLoadEventUserState As Object) As List(Of rowVwClientUsers)
            Dim zCmd As New SqlClient.SqlCommand(pSQL)
        ...
        Public Shared Function LoadData(pCommand As SqlClient.SqlCommand, ByRef pTransaction As SqlClient.SqlTransaction, pLoadEventUserState As Object) As List(Of rowVwClientUsers)
            Dim zReturn As New List(Of rowVwClientUsers)
            Dim zSQL As String = "SELECT * FROM [gv].[vwClientUsers]"
        ...
        Public Shared Function ReadData(pCommand As SqlClient.SqlCommand, pLoadEventUserState As Object) As List(Of rowVwClientUsers)

			Try
	            Dim zReturn As New List(Of rowVwClientUsers)		
	            Dim zReader As SqlClient.SqlDataReader = razor.UtilSQLServer.ExecuteReader(pCommand)
	            Dim zObj As New rowVwClientUsers

	            Using pCommand
	                Using zReader
	                    If zReader.HasRows() Then
	                        While zReader.Read
	                            zObj = New rowVwClientUsers		
		...
		Public Shared Function ReadDataRow(pReader As SqlClient.SqlDataReader, ByRef pObject As rowVwClientUsers)
    ...
    End Class
	<serializable>
    Partial Public Class rowVwClientUsers
        Implements IrowVwClientUsers

        Public Event Loaded(pUserState As Object) Implements IrowVwClientUsers.Loaded
        Public Event Saved(pUserState As Object) Implements IrowVwClientUsers.Saved
        Public Event Deleted(pUserState As Object) Implements IrowVwClientUsers.Deleted


        Public Sub RaiseLoadedEvent(pUserState As Object) Implements IrowVwClientUsers.RaiseLoadedEvent
            RaiseEvent Loaded(pUserState)
        End Sub

        Public Sub RaiseDeletedEvent(pUserState As Object) Implements IrowVwClientUsers.RaiseDeletedEvent
            RaiseEvent Deleted(pUserState)
        End Sub

        Public Sub RaiseSavedEvent(pUserState As Object) Implements IrowVwClientUsers.RaiseSavedEvent
            RaiseEvent Saved(pUserState)
        End Sub
        Public Property colFilePrefix() As Nullable(Of Short) Implements IrowVwClientUsers.colFilePrefix
            Get
        ...
        Public Property colReclassificationLinkGUID() As String Implements IrowVwClientUsers.colReclassificationLinkGUID
            Get
        ...
        Public Property colUserIndex() As Nullable(Of Long) Implements IrowVwClientUsers.colUserIndex
            Get
        ...
        Public Property colUserTotalCount() As Nullable(Of Integer) Implements IrowVwClientUsers.colUserTotalCount
            Get
        ...
        Public Property colUserCertifiedCount() As Nullable(Of Integer) Implements IrowVwClientUsers.colUserCertifiedCount
            Get
        ...
        Public Property colFullName() As String Implements IrowVwClientUsers.colFullName
            Get
        ...
        Public Property colEzyUserId() As Nullable(Of Integer) Implements IrowVwClientUsers.colEzyUserId
            Get
        ...
        Public Property colEzyGuid() As String Implements IrowVwClientUsers.colEzyGuid
            Get
                Return m_colEzyGuid
            End Get
            Set
        ...
        Public Property colActiveUser() As String Implements IrowVwClientUsers.colActiveUser
            Get
        ...
        Public Property colAccessLevel() As String Implements IrowVwClientUsers.colAccessLevel
            Get
        ...
        Public Property colAccessLevelDetails() As String Implements IrowVwClientUsers.colAccessLevelDetails
            Get
        ...
        Public Property colEmail() As String Implements IrowVwClientUsers.colEmail
            Get
                Return m_colEmail
            End Get
            Set
        ...
        Public Property colCCOnly() As String Implements IrowVwClientUsers.colCCOnly
            Get
                Return m_colCCOnly
            End Get
            Set
        ...
        Public Property colDateTimeStamp() As String Implements IrowVwClientUsers.colDateTimeStamp
            Get
        ...
        Public Property colLastLogin() As String Implements IrowVwClientUsers.colLastLogin
            Get
        ...
        Public Property colComment() As String Implements IrowVwClientUsers.colComment
            Get
                Return m_colComment
            End Get
            Set
        ...
        Public Property colClientComment() As String Implements IrowVwClientUsers.colClientComment
            Get
        ...
        Public Property colRInit() As String Implements IrowVwClientUsers.colRInit
            Get
                Return m_colRInit
            End Get
            Set
        ...
        Public Property colRReport() As String Implements IrowVwClientUsers.colRReport
            Get
                Return m_colRReport
            End Get
            Set
        ...
        Public Property colRfu1() As String Implements IrowVwClientUsers.colRfu1
            Get
                Return m_colRfu1
            End Get
            Set
        ...
        Public Property colRfu2() As String Implements IrowVwClientUsers.colRfu2
            Get
                Return m_colRfu2
            End Get
            Set
        ...
        Public Property colRfu3() As String Implements IrowVwClientUsers.colRfu3
            Get
                Return m_colRfu3
            End Get
            Set
        ...
        Public Property colROverdue1() As String Implements IrowVwClientUsers.colROverdue1
            Get
        ...
        Public Property colROverdue2() As String Implements IrowVwClientUsers.colROverdue2
            Get
        ...
        Public Property colROverdue3() As String Implements IrowVwClientUsers.colROverdue3
            Get
        ...
        Public Property colExpOverdue() As String Implements IrowVwClientUsers.colExpOverdue
            Get
        ...
        Public Property colRExpd() As String Implements IrowVwClientUsers.colRExpd
            Get
                Return m_colRExpd
            End Get
            Set
        ...
        Public Property colActionId() As Nullable(Of Integer) Implements IrowVwClientUsers.colActionId
            Get
        ...
        Public Function IsDirty(pIndex As rowVwClientUsers.FieldIndex) As Boolean Implements IrowVwClientUsers.IsDirty
            Return m_IsDirty(pIndex)
        End Function

        Public Function IsDirty() As Boolean Implements IrowVwClientUsers.IsDirty
            Return m_IsDirty.Contains(True)
        End Function

        Public Sub SetIsDirty(pDirty As Boolean) Implements IrowVwClientUsers.SetIsDirty
        ...
        End Sub
		 ...
		 ''' <summary>
        ''' Returns the type (VwClientUsers) that is able to save, update or delete using this row object.
        ''' </summary>
        ''' <returns>Returns the TblpmactivitiesCfc Type</returns>
        ''' <remarks></remarks>
		Public Shared Function GetTableType() As Type
			Dim zObj As New VwClientUsers
            Return zObj.GetType
		End Function
    ...
    Public Interface IrowVwClientUsers
        ...
        Function IsDirty(pIndex As rowVwClientUsers.FieldIndex) As Boolean
