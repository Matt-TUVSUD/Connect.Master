...
Public Class RecommendationExportHandler
    ...
    Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Try
            ...
            If context.Request.Form("XMLData") <> Nothing Then
                If context.Request.Form("XMLData").Length > 0 Then
                    ...
                    context.Response.AddHeader("Content-Disposition", "attachment;filename=RecommendationExport.xls")
        ...
        Catch ex As Exception
            ...
            zErrLogError.ApplicationPage = "RecommendationExport.ashx"
