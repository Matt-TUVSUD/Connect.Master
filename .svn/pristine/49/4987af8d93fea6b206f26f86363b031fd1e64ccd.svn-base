<%@ Page Title="Fire Program Location Listing | Global Risk Consultants" Language="vb" AutoEventWireup="false" MasterPageFile="~/Home_{{VER}}/ClientConnectServerLocationList.Master" CodeBehind="Default.aspx.vb" Inherits="GRC.Connect.Web.DefaultFire" %>
