<%@ Page Language="vb"  MasterPageFile="~/Home_{{VER}}/Charts/ChartMasterPageRecommendations.master" AutoEventWireup="false" CodeBehind="RatingTrendingFireActive.aspx.vb" Inherits="GRC.Connect.Web.Charts_RatingTrendingFireActive" %>
...
<asp:Content ID="ChartHeadContent" runat="server" ContentPlaceHolderID="ChartHeadContent">
    ...
    <script src="../../../Lib_{{VER}}/Charts/RatingTrendingFireActive.js"></script>
    <script>
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <div style="display:flex; justify-content:space-between; align-items:center; width:275px;">
                                            <button ID="btnPDF" class="grcGreenBtn" data-bind="click: downloadPDFHandler" style="background:#00b140;color: #fff;font-weight: 700;border: none;border-radius: 0px;padding: 5px;width: 130px;height: 35px;">Save/Print</button>
                                            <input id="cmdClose" class="grcNeutralBtn" style="background:#eee;color: #0046ad;font-weight: 700;border: 2px solid #0046ad;border-radius: 0px;padding: 5px;width: 130px;height: 35px;" type="button" value="Close" onclick="window.close();" />
                                        </div>
                                    </td>
                                </tr>
                            </table>
                ...
                <div class="chartContainerOutside">
                    <table cellspacing="0" cellpadding="0" style="padding: 0; border-collapse: collapse">
                        <tr>
                            ...
                            <%-- *** ZZZ TO DO: CHANGE TO CORRECT HEADERS --%>
                            <td class="chartHeaderContainer headerActive">
                                Protection
                            </td>
                            <td class="chartHeaderContainer headerActive">
                                Human Element
                        ...
                        <tr>
                            ...
                            <%-- *** ZZZ TO DO: CHANGE TO CORRECT CHART IDS AND CHART CONTAINERS --%>
                            <td class="chartContainer"><div data-bind="attr: { id: 'chartProtection' + $index() }"></div></td>
                            <td class="chartContainer"><div data-bind="attr: { id: 'chartHuman' + $index() }"></div></td>
                            <td class="chartContainer"><div data-bind="attr: { id: 'chartNatHaz' + $index() }"></div></td>
                            <td class="chartContainer"><div data-bind="attr: { id: 'chartBusiness' + $index() }"></div></td>
                        </tr>
                        <!-- /ko -->
                    </table>
                </div>            
    ...
    <div id="windowPleaseWait" class="windowContent printNone">
        ...
        <div id="windowPleaseWaitProcessed" style="display:flex; flex-direction:column; align-items:center; justify-content:center; font-size:13px;">
            ...
            <div style="display:flex; justify-content:center;width:100%;">
                <button class="ghrcNeutralBtn" data-bind="click: onCancelMultiPring">Cancel</button>
            </div>
        </div>
