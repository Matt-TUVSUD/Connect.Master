<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tab_rectracking.aspx.vb" Inherits="GRC.Connect.Web.tab_rectracking_processsafety" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../Lib_{{VER}}/Generated/ViewCCLocationListingPS.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Custom/ViewCCLocationListingPS.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Generated/PSRecommendations.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Custom/PSRecommendations.js" type="text/javascript"></script>
...
<div id="view_RecTracking" data-bind="with: view_RecTracking">
    ...
    <div class="tableDiv">
        ...
        <div class="tabRow">
            ...
            <span class="buttonContainerLocationLoading" style="display:flex;">
                ...
                <span><button data-bind="click: $parent.onFilePrevious, enable: $parent.enableFilePrev" type="button" class="grcBlueBtn pagerBtn" id="btnFilePrevious" tabindex="16"><i class="fa fa-caret-left"></i></button></span>
                ...
                <span><button data-bind="click: $parent.onFileNext, enable: $parent.enableFileNext" type="button" class="grcBlueBtn pagerBtn" id="btnFileNext" tabindex="17" style="margin-right:2px;"><i class="fa fa-caret-right"></i></button></span>
    ...
    widget: $parent.widgetRecStatus
        ...
        <div class="tabRow">
            ...
            <span class="recInputRangeLargeActualBoiler"><input data-bind="value: $parent.objRec().LossExpectancyBeforeActual" id="LossExpectancyBeforeActual" class="k-autocomplete k-input inputNoEdit inputLeft recInputRangeLargeActualBoiler" readonly="readonly" /></span>
            <span class="recInputRangeLargeActualBoiler"><input data-bind="value: $parent.objRec().LossExpectancyAfterActual" id="LossExpectancyAfterActual" class="k-autocomplete k-input inputNoEdit inputLeft recInputRangeLargeActualBoiler" readonly="readonly" /></span>
            <span class="recInputRangeLargeActualBoiler"><input data-bind="value: $parent.objRec().CostToCompleteActual" id="CostToCompleteActual" class="k-autocomplete k-input inputNoEdit inputLeft recInputRangeLargeActualBoiler" readonly="readonly" /></span>
    ...
    widget: $parent.widgetIntendedActionThirdLevel
            ...
            <div class="tabRow">
                <span class="recLabelLeft" style="height: 32px; width: 99px;">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var dsLanguageLabels = {
            ...
            lblSearchNotFound: "This location is not active for Process Safety.  Choose a different service.",
        ...
        var view_RecTracking = {
            ...
            collRec: new es.objects.PSRecommendationsCollection(),
            collListing: new es.objects.ViewCCLocationListingPSCollection(),
            ...
            loadDetailsOnly: function () {
                ...
                if (view_RecTracking.stateDetailsLoadOneRecord == true && view_RecTracking.stateLoadError == false) {
                    if (!view_RecTracking.collRec.PSRecommendationCollection_BrowseByLocation(tempParm + "|" + tempHemisphere + "|one")) { view_RecTracking.stateLoadError = false } else { view_RecTracking.stateLoadError = true }
                    view_RecTracking.stateDetailsLoadOneRecord = false;
                    view_RecTracking.stateOnlyOneDetailRecordLoaded = true;
                } else {
                    if (!view_RecTracking.collRec.PSRecommendationCollection_BrowseByLocation(tempParm + "|" + tempHemisphere + "|all")) { view_RecTracking.stateLoadError = false } else { view_RecTracking.stateLoadError = true }
                    view_RecTracking.stateDetailsLoadOneRecord = false;
            ...
            loadOneFileNumber: function () {
                ...
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view_RecTracking.collListing.ViewCCLocationPSCollections(tempParm)) { view_RecTracking.stateLoadError = false } else { view_RecTracking.stateLoadError = true }
                view_RecTracking.stateListingLoadOneRecord = false;

                var tempHemisphere = getHemisphere(calculate_time_zone());
                tempParm = view_RecTracking.gSafeGuid + "|" + tempHemisphere + "|one";
                es.dataProvider.baseURL = SITEBASEURL + DATASERVERENDPOINT;
                if (!view_RecTracking.collRec.PSRecommendationCollection_BrowseByLocation(tempParm)) { view_RecTracking.stateLoadError = false } else { view_RecTracking.stateLoadError = true }
                view_RecTracking.stateDetailsLoadOneRecord = false;
                view_RecTracking.stateOnlyOneDetailRecordLoaded = true;
            ...
            onSave: function () {
                ...
                var objTemp = new es.objects.PSRecommendations();
