...
Public Class FacilityRatingFromChart_fire
    Inherits System.Web.UI.Page

    Private Sub ValidatePage()
        Dim zGUID As String = GetGUIDFromQueryString()
        CorrectPageCheck(zGUID, PageId_FacilityRating_Fire, PageId_FacilityRating_Fire)
    ...
    Private Sub loadDefaults()
        Dim zGUID As String = GetGUIDFromQueryString()
        SetFireFacilityRatingPractice(zGUID)
