...
(function (es) { //myNS = "myNameSpace" ... for example purposes
	...
	es.objects.ViewCCLocationInspectionFire = es.defineEntity(function () {
	...
	es.objects.ViewCCLocationInspectionFire.prototype.esTypeDefs = {};

	es.objects.ViewCCLocationInspectionFire.prototype.esRoutes = {
		commit: { method: 'PUT', url: 'ViewCCLocationInspectionFire_Save', response: 'entity' }
	};

	es.objects.ViewCCLocationInspectionFire.prototype.esColumnMap = {
		'FileNo': 1,
		'FilePrefix': 1,
		'PracticeCode': 1,
		'Engineer': 1,
...
(function (es) {
	...
	es.objects.ViewCCLocationInspectionFireCollection = es.defineCollection('ViewCCLocationInspectionFireCollection', 'ViewCCLocationInspectionFire');

	//#region Prototype Level Information

	es.objects.ViewCCLocationInspectionFireCollection.prototype.esRoutes = {
		commit: { method: 'PUT', url: 'ViewCCLocationInspectionFireCollection_Save', response: 'collection' },
		loadAll: { method: 'GET', url: 'ViewCCLocationInspectionFireCollection_LoadAll', response: 'collection' }
	};
