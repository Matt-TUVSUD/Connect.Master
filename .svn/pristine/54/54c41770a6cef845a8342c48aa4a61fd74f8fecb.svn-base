<%@ Page Title="Recommendation Response | Global Risk Consultants" Language="vb" AutoEventWireup="false" MasterPageFile="~/RecResponse_{{VER}}/ClientConnectRecResponse.Master" CodeBehind="rectracking.aspx.vb" Inherits="GRC.Connect.Web.rectracking_ps_recresponse" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Lib_{{VER}}/Generated/ViewCCLocationListingRecResponsePS.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Custom/ViewCCLocationListingRecResponsePS.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="tableDiv" style="width: 100%;">
        ...
        <div class="tabRow">
            ...
            <span class="recLabelLeft"><label class="recLabelVerticalCenter" data-bind="text: $parent.objLanguageLabels().lblPrimaryRecType">Primary Rec. Type</label></span>
            <span class="recInputHazard" id="">
                <input data-bind="value: $parent.widgetPrimaryRecType, attr: { title: $parent.widgetPrimaryRecType }" id="PrimaryRecType" class="k-autocomplete k-input inputNoEdit inputLeft recInputHazard" readonly="readonly" />
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var view = {
            ...
            collListing: new es.objects.ViewCCLocationListingRecResponsePSCollection(),
            collCounts: new es.objects.ViewCCPSRecommendationCountsCollection(),
            ...
            loadPickers: function () {
                ...
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view.collPrimaryrectype.GetPrimaryRecTranslationByLanguage(view.preferenceLanguage + "|" + "ProcessSafety")) {
                    tempArray = new Array();
                ...
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view.collSecondaryrectype.GetSecondaryRecTranslationByLanguage(view.preferenceLanguage + "|" + "ProcessSafety")) {
            ...
            loadCounts: function () {
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view.collCounts.GetRecommendationCountsPS(view.fileNo)) {
            ...
            loadDetailsOnly: function () {
                ...
                if (view.stateDetailsLoadOneRecord == true && view.stateLoadError == false) {
                    if (!view.collRec.GetPSRecByFileNo(tempParm + "|" + tempHemisphere + "|one")) { view.stateLoadError = false } else { view.stateLoadError = true }
                    view.stateDetailsLoadOneRecord = false;
                    view.stateOnlyOneDetailRecordLoaded = true;
                } else {
                    if (!view.collRec.GetPSRecByFileNo(tempParm + "|" + tempHemisphere + "|all")) { view.stateLoadError = false } else { view.stateLoadError = true }
                    view.stateDetailsLoadOneRecord = false;
            ...
            loadOneFileNumber: function () {
                ...
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view.collListing.GetRecResponsePSLocationByFileNo(tempParm)) { view.stateLoadError = false } else { view.stateLoadError = true }
                view.stateListingLoadOneRecord = false;

                tempParm = view.fileNo + "|" + tempHemisphere + "|one";
                es.dataProvider.baseURL = SITEBASEURL + DATASERVERENDPOINT;
                if (!view.collRec.GetPSRecByFileNo(tempParm)) { view.stateLoadError = false } else { view.stateLoadError = true }
                view.stateDetailsLoadOneRecord = false;
                view.stateOnlyOneDetailRecordLoaded = true;
