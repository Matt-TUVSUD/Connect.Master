...
Public Class _RecResponse_Redirect_RecResponse
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ' REDIRECT TO THE CORRECT HOME PAGE IN THE RecResponse_{{VER}} FOLDER
        Response.Redirect("~/RecResponse_{{VER}}/Auth/?pBuffer=0" & zP1 & zP2 & zT & zI, False)
