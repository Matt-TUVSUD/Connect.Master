...
Namespace razor
    Public Class queryVwMetaGridColumns
        Inherits razor.UtilSQLServer.Query

        Private _Members As New Dictionary(Of String, Object)

        Public colFldFilePrefix As New razor.UtilSQLServer.IntegerDataColumn
        Public colFldDisplayTitle As New razor.UtilSQLServer.StringDataColumn
        ...
        Public Sub New()
            ...
            colFldDisplayTitle.ColumnName = "[fldDisplayTitle]"
            ...
            _Members.Add("colFldDisplayTitle", colFldDisplayTitle)
        ...
        Public Function MemberColumn(pObjectName As String) As String
            Select Case pObjectName
                ...
                Case "colFldDisplayTitle"
                    Return "[fldDisplayTitle]"
                Case "colFldId"
                    Return "[fldId]"
        ...
        Public Function Column2Member(pColumnName As String) As String
            Select Case pColumnName
                ...
                Case "[fldDisplayTitle]", "fldDisplayTitle", "FldDisplayTitle", "colFldDisplayTitle"  
                    Return "colFldDisplayTitle"
