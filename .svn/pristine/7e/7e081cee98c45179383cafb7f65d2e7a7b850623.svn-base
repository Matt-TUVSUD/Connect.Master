<%@ Page Title="Rec. Response Grid | Global Risk Consultants" Language="vb" AutoEventWireup="false" MasterPageFile="~/RecResponse_{{VER}}/ClientConnectRecResponse.Master" CodeBehind="recdatasheetfeaturesX.aspx.vb" Inherits="GRC.Connect.Web.recdatasheetfeaturesX_fire_recresponse" %>
        ...
        var view = {
            ...
            createGridObject: function () {
                if (view.enableMgmtFields() == false) {
                    ...
                    { field: "RecCode", width: "75px", title: view.objLanguageLabels().lblRecCode },
            ...
            createColumnTitles: function () {
                ...
                view.columnTitles.push(view.objLanguageLabels().lblRecCode);
