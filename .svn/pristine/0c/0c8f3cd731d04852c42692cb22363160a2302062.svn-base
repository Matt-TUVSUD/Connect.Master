...
Namespace razor
    Partial Public Class ViewCCGRIPSSLocationsV2

        Public Shared Function LoadData() As List(Of rowViewCCGRIPSSLocationsV2)
            Return LoadData(New SqlClient.SqlCommand(), Nothing, Nothing)
        End Function

        Public Shared Function LoadData(pLoadEventUserState As Object) As List(Of rowViewCCGRIPSSLocationsV2)
            Return LoadData(New SqlClient.SqlCommand(), Nothing, pLoadEventUserState)
        End Function

        Public Shared Function LoadData(pSQL As String) As List(Of rowViewCCGRIPSSLocationsV2)
            Dim zCmd As New SqlClient.SqlCommand(pSQL)
            Return LoadData(zCmd, Nothing, Nothing)
        End Function

        Public Shared Function LoadData(pSQL As String, ByRef pTransaction As SqlClient.SqlTransaction) As List(Of rowViewCCGRIPSSLocationsV2)
            Dim zCmd As New SqlClient.SqlCommand(pSQL)
            Return LoadData(zCmd, pTransaction, Nothing)
        End Function

        Public Shared Function LoadData(pSQL As String, ByRef pTransaction As SqlClient.SqlTransaction, pLoadEventUserState As Object) As List(Of rowViewCCGRIPSSLocationsV2)
            Dim zCmd As New SqlClient.SqlCommand(pSQL)
        ...
        Public Shared Function LoadData(pCommand As SqlClient.SqlCommand, ByRef pTransaction As SqlClient.SqlTransaction, pLoadEventUserState As Object) As List(Of rowViewCCGRIPSSLocationsV2)
            Dim zReturn As New List(Of rowViewCCGRIPSSLocationsV2)
            Dim zSQL As String = "SELECT * FROM [dbo].[viewCCGRIPSSLocationsV2]"
        ...
        Public Shared Function ReadData(pCommand As SqlClient.SqlCommand, pLoadEventUserState As Object) As List(Of rowViewCCGRIPSSLocationsV2)

			Try
	            Dim zReturn As New List(Of rowViewCCGRIPSSLocationsV2)		
	            Dim zReader As SqlClient.SqlDataReader = razor.UtilSQLServer.ExecuteReader(pCommand)
	            Dim zObj As New rowViewCCGRIPSSLocationsV2

	            Using pCommand
	                Using zReader
	                    If zReader.HasRows() Then
	                        While zReader.Read
	                            zObj = New rowViewCCGRIPSSLocationsV2		
		...
		Public Shared Function ReadDataRow(pReader As SqlClient.SqlDataReader, ByRef pObject As rowViewCCGRIPSSLocationsV2)
    ...
    End Class
	<serializable>
    Partial Public Class rowViewCCGRIPSSLocationsV2
        Implements IrowViewCCGRIPSSLocationsV2

        Public Event Loaded(pUserState As Object) Implements IrowViewCCGRIPSSLocationsV2.Loaded
        Public Event Saved(pUserState As Object) Implements IrowViewCCGRIPSSLocationsV2.Saved
        Public Event Deleted(pUserState As Object) Implements IrowViewCCGRIPSSLocationsV2.Deleted


        Public Sub RaiseLoadedEvent(pUserState As Object) Implements IrowViewCCGRIPSSLocationsV2.RaiseLoadedEvent
            RaiseEvent Loaded(pUserState)
        End Sub

        Public Sub RaiseDeletedEvent(pUserState As Object) Implements IrowViewCCGRIPSSLocationsV2.RaiseDeletedEvent
            RaiseEvent Deleted(pUserState)
        End Sub

        Public Sub RaiseSavedEvent(pUserState As Object) Implements IrowViewCCGRIPSSLocationsV2.RaiseSavedEvent
            RaiseEvent Saved(pUserState)
        End Sub
        Public Property colFilePrefix() As String Implements IrowViewCCGRIPSSLocationsV2.colFilePrefix
            Get
        ...
        Public Property colFileNo() As String Implements IrowViewCCGRIPSSLocationsV2.colFileNo
            Get
                Return m_colFileNo
            End Get
            Set
        ...
        Public Property colDivision() As String Implements IrowViewCCGRIPSSLocationsV2.colDivision
            Get
        ...
        Public Property colCustomAccess() As String Implements IrowViewCCGRIPSSLocationsV2.colCustomAccess
            Get
        ...
        Public Property colClientLocNo() As String Implements IrowViewCCGRIPSSLocationsV2.colClientLocNo
            Get
        ...
        Public Property colFacility() As String Implements IrowViewCCGRIPSSLocationsV2.colFacility
            Get
        ...
        Public Property colCity() As String Implements IrowViewCCGRIPSSLocationsV2.colCity
            Get
                Return m_colCity
            End Get
            Set
        ...
        Public Property colStProv() As String Implements IrowViewCCGRIPSSLocationsV2.colStProv
            Get
                Return m_colStProv
            End Get
            Set
        ...
        Public Property colCountry() As String Implements IrowViewCCGRIPSSLocationsV2.colCountry
            Get
                Return m_colCountry
            End Get
            Set
        ...
        Public Property colCityStProvCountry() As String Implements IrowViewCCGRIPSSLocationsV2.colCityStProvCountry
            Get
        ...
        Public Property colStProvCountry() As String Implements IrowViewCCGRIPSSLocationsV2.colStProvCountry
            Get
        ...
        Public Function IsDirty(pIndex As rowViewCCGRIPSSLocationsV2.FieldIndex) As Boolean Implements IrowViewCCGRIPSSLocationsV2.IsDirty
            Return m_IsDirty(pIndex)
        End Function

        Public Function IsDirty() As Boolean Implements IrowViewCCGRIPSSLocationsV2.IsDirty
            Return m_IsDirty.Contains(True)
        End Function

        Public Sub SetIsDirty(pDirty As Boolean) Implements IrowViewCCGRIPSSLocationsV2.SetIsDirty
        ...
        End Sub
		 ...
		 ''' <summary>
        ''' Returns the type (ViewCCGRIPSSLocationsV2) that is able to save, update or delete using this row object.
        ''' </summary>
        ''' <returns>Returns the TblpmactivitiesCfc Type</returns>
        ''' <remarks></remarks>
		Public Shared Function GetTableType() As Type
			Dim zObj As New ViewCCGRIPSSLocationsV2
            Return zObj.GetType
		End Function
    ...
    Public Interface IrowViewCCGRIPSSLocationsV2
        ...
        Function IsDirty(pIndex As rowViewCCGRIPSSLocationsV2.FieldIndex) As Boolean
