<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tab_rectracking.aspx.vb" Inherits="GRC.Connect.Web.tab_rectracking_boiler" %>
...
<head runat="server">
    ...
    <script src="../../Lib_{{VER}}/Generated/BMRecommendations.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Custom/BMRecommendations.js" type="text/javascript"></script>
...
<div id="view_RecTracking" data-bind="with: view_RecTracking">
    ...
    <div class="tableDiv">
        ...
        <div class="tabRow">
            ...
            <span class="recLabelLeftBoiler" style="height: 21px;"><label data-bind="text: $parent.objLanguageLabels().lblRecNo">Rec. No.</label></span>
            ...
            <span class="recLabelRec" style="height: 21px; padding-left: 6px;"><label data-bind="text: $parent.objLanguageLabels().lblRecImpact">Rec. Impact</label></span>
            <span class="recInputRec" id="RecCategory" style="height: 21px;">
                <select class="inputNoEdit recInputRec" id="selRecCategory" data-bind="kendoDropDownList: {
    ...
    widget: $parent.widgetRecCategory
            ...
            <span class="recInputRec" id="RecStatus" style="height: 21px;">
                <select  class="inputNoEdit recInputRec" id="selRecStatus" data-bind="kendoDropDownList: {
    ...
    widget: $parent.widgetRecStatus
        ...
        <div class="tabRow">
            ...
            <span class="recLabelLeftBoiler"><label data-bind="text: $parent.objLanguageLabels().lblPrimaryRecType">Primary Rec. Type</label></span>
            <span class="recInputHazard"><input readonly="readonly" data-bind="value: $parent.objRec().PrimaryRecType" id="PrimaryRecTypeText" class="k-autocomplete k-input inputNoEdit inputLeftKendo recInputHazard" /></span>
            <span class="recLabelHazard" style="padding-left: 0px;"><label data-bind="text: $parent.objLanguageLabels().lblSecondaryRecType">Secondary Rec. Type</label></span>
            <span class="recInputHazard"><input readonly="readonly" data-bind="value: $parent.objRec().SecondaryRecType" id="SecondaryRecTypeText" class="k-autocomplete k-input inputNoEdit inputLeftKendo recInputHazard" /></span>
            <span class="bufferRight" style="padding-left: 7px;"></span>
        </div>
        <div class="tabRow">
            <span class="bufferLeft"></span>
            <span class="recLabelLeftBoiler"><label data-bind="text: $parent.objLanguageLabels().lblRecKeyWord">Rec. Key Word</label></span>
            <span class="recInputKeyWordsLongBoiler"><input data-bind="value: $parent.objRec().RecKeyWords" id="RecKeyWords" class="k-autocomplete k-input inputNoEdit inputLeftKendo recInputKeyWordsLongBoiler" /></span>
        ...
        <div class="tabRow">
            <span class="bufferLeft"></span>
            <span class="recLabelLeftBoiler">&nbsp;</span>
            <span class="recLabelRangeLargeBoiler"><label data-bind="text: $parent.objLanguageLabels().lblCurrentLossEst">Current Loss Est.</label></span>
            <span class="recLabelRangeLargeBoiler"><label data-bind="text: $parent.objLanguageLabels().lblCompletedLossEst">Completed Loss Est.</label></span>
            <span class="recLabelRangeLargeBoiler"><label data-bind="text: $parent.objLanguageLabels().lblEstCostToComplete">Est. Cost to Complete</label></span>
            <span class="recLabelRangeSmallBoiler" style="padding-left: 5px;"><label data-bind="text: $parent.objLanguageLabels().lblSavingsRatio">Savings Ratio</label></span>
            <span class="recLabelRangeLargeBoiler"><label data-bind="text: $parent.objLanguageLabels().lblActCostToComplete">Act. Cost to Complete</label></span>
            <span class="bufferRight" style="padding-left: 1px;"></span>
        </div>
        <!-- ACTUAL LE FIELDS SHOWN ONLY IF CLIENT FEATURES CONTAIN 'L' -->
        <div class="tabRow">
            <span class="bufferLeft"></span>
            <span class="recLabelLeftBoiler"><label data-bind="text: $parent.objLanguageLabels().lblActual">Actual</label></span>
            <span class="recInputRangeLargeActualBoiler"><input data-bind="value: global.formatMoneyNoSymbol($parent.objRec().LossExpectancyBeforeActual(), 0, '')" id="LossExpectancyBeforeActual" class="k-autocomplete k-input inputNoEdit inputLeft recInputRangeLargeActualBoiler" readonly="readonly" /></span>
            <span class="recInputRangeLargeActualBoiler"><input data-bind="value: global.formatMoneyNoSymbol($parent.objRec().LossExpectancyAfterActual(), 0, '')" id="LossExpectancyAfterActual" class="k-autocomplete k-input inputNoEdit inputLeft recInputRangeLargeActualBoiler" readonly="readonly" /></span>
            <span class="recInputRangeLargeActualBoiler"><input data-bind="value: global.formatMoneyNoSymbol($parent.objRec().CostToCompleteActual(), 0, '')" id="CostToCompleteActual" class="k-autocomplete k-input inputNoEdit inputLeft recInputRangeLargeActualBoiler" readonly="readonly" /></span>
            <span class="bufferRight" style="padding-left: 2px;"></span>
        </div>
        <!-- LE FIELDS -->
        <div class="tabRow">
            <span class="bufferLeft"></span>
            <span class="recLabelLeftBoiler"><label data-bind="text: $parent.objLanguageLabels().lblRange">Range</label></span>
            <span class="recInputRangeCellLarge" id="LossExpectancyBefore">
                <select class="inputNoEdit recInputRangeLargeBoiler" id="selLossExpectancyBefore" data-bind="kendoDropDownList: {
    ...
    widget: $parent.widgetLossExpectancyBefore
            ...
            <span class="recInputRangeCellLarge" id="LossExpectancyAfter">
                <select class="inputNoEdit recInputRangeLargeBoiler" id="selLossExpectancyAfter" data-bind="kendoDropDownList: {
    ...
    widget: $parent.widgetLossExpectancyAfter
            ...
            <span class="recInputRangeCellLarge" id="CostToComplete">
                <select class="inputNoEdit recInputRangeLargeBoiler" id="selCostToComplete" data-bind="kendoDropDownList: {
    ...
    widget: $parent.widgetCostToComplete
            ...
            <span class="recInputRangeSmallCellBoiler"><input data-bind="value: $parent.objRec().SavingsRatio" id="SavingsRatio" class="k-autocomplete k-input inputNoEdit inputLeftKendo recInputRangeSmallCellBoiler" /></span>
            <span class="recInputActualCostToCompleteBoiler" style="padding-left: 19px;"><input data-bind="value: $parent.objRec().ActualCostToComplete" id="ActualCostToComplete" class="k-autocomplete k-input inputNoEdit inputLeft recInputActualCostToCompleteBoiler" /></span>
            <span class="bufferRight" style="padding-left: 2px;"></span>
        </div>
        <div class="tabRow">
            <span class="bufferLeft"></span>
            <span class="recLabelLeftBoiler"><label data-bind="text: $parent.objLanguageLabels().lblRespDate">Resp. Date</label></span>
            ...
            <span class="recInputRespSmallBoiler"><input data-bind="value: $parent.objRec().ResponseFrom" id="ResponseFrom" class="k-autocomplete k-input inputNoEdit inputLeftKendo recInputRespSmallBoiler" /></span>
            ...
            <span class="recInputIntendedActionSmall" id="IntendedAction">
                <select class="inputNoEdit recInputIntendedActionSmall" id="selIntendedAction" data-bind="kendoDropDownList: {
    ...
    widget: $parent.widgetIntendedAction
            ...
            <span class="recInputDateSmall"><input data-bind="" id="ExpectedCompletionDate" class="k-autocomplete inputNoEdit recInputDateSmall" /></span>
            <span class="bufferRight" style="padding-left: 4px;"></span>
        </div>
        <div class="tabRow">
            <span class="bufferLeft" style="height: 32px;"></span>
            <span class="recLabelLeftBoiler" style="height: 32px;"><label data-bind="text: $parent.objLanguageLabels().lblFacilityComment">Facility Comment</label></span>
            <span class="recInputCommentsLargeBoiler" style="height: 32px;">
                <textarea data-bind="value: $parent.objRec().PlantComment, attr: { title: $parent.objRec().PlantComment }" id="PlantComment" class="k-textbox inputNoEdit recInputCommentsLargeBoiler" rows="8" cols="20" style="white-space: pre-wrap;"></textarea>
            </span>
        ...
        <div class="tabRow" data-bind="if: $parent.clientFeatures().search('Q') > -1">
            <span class="bufferLeft"></span>
            <span class="recLabelLeft" style="width:96px;"><label data-bind="text: $parent.objLanguageLabels().lblMgmtRespDate">Mgmt. Resp. Date</label></span>
    ...
    widget: $parent.widgetIntendedActionMgmt
        ...
        <div class="tabRow" data-bind="if: $parent.clientFeatures().search('Q') > -1">
            <span class="bufferLeft" style="height: 32px;"></span>
            <span class="recLabelLeft" style="height: 32px; width:95px;"><label data-bind="text: $parent.objLanguageLabels().lblMgmtComment">Mgmt. Comment</label></span>
            <span class="recInputCommentsLarge" style="height: 32px;">
                <textarea data-bind="value: $parent.objRec().MgmtRespComment, attr: { title: $parent.objRec().MgmtRespComment }" id="MgmtRespComment" class="k-textbox inputNoEdit recInputCommentsLarge" rows="8" cols="20" style="white-space: pre-wrap; width:700px;"></textarea>
            </span>
        </div>
        ...
        <div data-bind="if: $parent.clientFeatures().search('@') > -1">
            <div class="tabRow">
                <span class="bufferLeft"></span><span class="recLabelLeft" style="width:96px;"><label>3rd Lvl Resp. Date</label></span>
                ...
                <span class="recLabelIntendedActionSmall" style="width:105px;"><label>3rd Lvl Action</label></span>
    ...
    widget: $parent.widgetIntendedActionThirdLevel
                ...
                <%--<span class="recLabelExpCompleteSmall">
                    <label data-bind="">Exp'd Compl. Date</label></span>
                <span class="recInputDateSmall">
                    <input data-bind="" id="lvl3CompDate" class="k-numerictextbox inputNoEdit recInputDateSmall" /></span>--%>
            </div>
            <div class="tabRow">
                <span class="bufferLeft" style="height: 32px;"></span>
                <span class="recLabelLeft" style="height: 32px; width:95px;">
                    <label data-bind="">3rd Lvl. Comment</label></span>
                <span class="recInputCommentsLarge" style="height: 32px;">
                    <textarea data-bind="value: $parent.objRec().ThirdLevelRespComment" id="lvl3Commment" class="k-textbox inputNoEdit recInputCommentsLarge" rows="8" cols="20" style="white-space: pre-wrap; width:700px;"></textarea>
                </span>
            </div>
        </div>
        ...
        <div class="tabRow">
            <span class="bufferLeft"></span>
            <span class="buttonCell" style="text-align: left; padding-left: 99px;"><button class="grcBlueBtn tabActionBtn" id="editSave" data-bind="click: $parent.onEditSave, text: $parent.txtEditSave, enable: $parent.enableNoLocationFound">Edit</button></span>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var view_RecTracking = {
            ...
            collRec: new es.objects.BMRecommendationsCollection(),
            ...
            onDatasheetView: function () {
                ...
                if (view_RecTracking.clientFeatures().search('L') > -1) {
                    ...
                    tempURL = "tab_recdatasheetFeaturesL.aspx?sid=" + view_RecTracking.gSafeGuid + "&rec=" + view_RecTracking.index;
                    //tempURL = "recdatasheet.aspx?sid=" + view_RecTracking.gSafeGuid + "&rec=" + view_RecTracking.index;
                }
            ...
            onEnablePickers: function () {
                if (view_RecTracking.adminUser) {
                    ...
                    if (view_RecTracking.enablePickers()) {
                        ...
                        if (view_RecTracking.clientFeatures().indexOf("Q") > -1) { MgmtRespDate.wrapper.find(".k-icon").hide(); }
            ...
            loadDetailsOnly: function () {
                ...
                if (view_RecTracking.stateDetailsLoadOneRecord == true && view_RecTracking.stateLoadError == false) {
                    if (!view_RecTracking.collRec.BMRecommendationCollection_BrowseByLocation(tempParm + "|" + tempHemisphere + "|one")) { view_RecTracking.stateLoadError = false } else { view_RecTracking.stateLoadError = true }
                    view_RecTracking.stateDetailsLoadOneRecord = false;
                    view_RecTracking.stateOnlyOneDetailRecordLoaded = true;
                } else {
                    if (!view_RecTracking.collRec.BMRecommendationCollection_BrowseByLocation(tempParm + "|" + tempHemisphere + "|all")) { view_RecTracking.stateLoadError = false } else { view_RecTracking.stateLoadError = true }
                    view_RecTracking.stateDetailsLoadOneRecord = false;
            ...
            loadOneFileNumber: function () {
                ...
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view_RecTracking.collListing.ViewCCLocationBMCollections(tempParm)) { view_RecTracking.stateLoadError = false } else { view_RecTracking.stateLoadError = true }
                view_RecTracking.stateListingLoadOneRecord = false;

                var tempHemisphere = getHemisphere(calculate_time_zone());
                tempParm = view_RecTracking.gSafeGuid + "|" + tempHemisphere + "|one";
                es.dataProvider.baseURL = SITEBASEURL + DATASERVERENDPOINT;
                if (!view_RecTracking.collRec.BMRecommendationCollection_BrowseByLocation(tempParm)) { view_RecTracking.stateLoadError = false } else { view_RecTracking.stateLoadError = true }
                view_RecTracking.stateDetailsLoadOneRecord = false;
                view_RecTracking.stateOnlyOneDetailRecordLoaded = true;
            ...
            onSave: function () {
                ...
                var objTemp = new es.objects.BMRecommendations();
        ...
        //        $("#RecSubletter").kendoAutoComplete();
        ...
        //        var RecSubletter = $("#RecSubletter").kendoAutoComplete().data("kendoAutoComplete");
        ...
        //        var RecKeyWords = $("#RecKeyWords").kendoAutoComplete().data("kendoAutoComplete");
        ...
        LossExpectancyBefore.find(".k-dropdown-wrap").addClass("expand-padding recInputRangeLargeBoiler").css("height", "14px").css("top", "-1px");
        ...
        LossExpectancyAfter.find(".k-dropdown-wrap").addClass("expand-padding recInputRangeLargeBoiler").css("height", "14px").css("top", "-1px");
        ...
        CostToComplete.find(".k-dropdown-wrap").addClass("expand-padding recInputRangeLargeBoiler").css("height", "14px").css("top", "-1px");
