...
Public Class tab_rectracking_boiler
    Inherits System.Web.UI.Page

    Private Sub ValidatePage()
        'CorrectPageCheck(GetGUIDFromQueryString, PageId_RecommendationTracking_Boiler, PageId_LocationListing_Boiler)
    ...
    Private Sub loadDefaults()
        ...
        'SetBoilerRecommendationTracking(zGUID)
        SetBoilerDetailsPractice(zGUID)
        'hypRecDatasheet.NavigateUrl = "~/Home_{{VER}}/Boiler/recdatasheet.aspx?sid=" & Request.QueryString("sid")
