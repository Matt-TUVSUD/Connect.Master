...
Public Class recdatasheetfeaturesL_wind_recresponse
    ...
    Private Sub loadData()
        ...
        If zObjListing.Load(zQryListing) Then
            ServerSide_ToFireReport = Replace(zObjListing.ToNatHazWindReport, "\", "\\")
            ServerSide_ToFireDiagram = Replace(zObjListing.ToNatHazWindDiagram, "\", "\\")
        End If
