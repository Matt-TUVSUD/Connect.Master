...
Partial Public Class FireFacilityRatingPassiveTrendingReport
    Inherits BaseReportLandscapeLegal
    ...
    Public Sub New()
        ...
        With _GraphBind
            .Add("uxFloodGraph", "Flood")
            .Add("uxEarthquakeGraph", "Earthquake")
            .Add("uxWindstormGraph", "Wind")
            .Add("uxConstructionGraph", "Construction")
            .Add("uxOccupancyGraph", "Occupancy")
            .Add("uxOtherExposureGraph", "OtherExposure")
        End With
    ...
    Public Function ReportTitle() As String Implements ITelerikReport.ReportTitle
        Return "Facility Rating Passive Trending Chart"
    End Function
    ...
    Private Sub TrendingReport_ItemDataBinding(sender As Object, e As EventArgs) Handles Me.ItemDataBinding
        ...
        UtilTrend.SetGraphProperties(Me, _GraphBind.Keys.ToArray, _DarkRedHexColor, False)
    ...
    Private Sub GraphNeedDataSourceHandler(sender As Object, e As EventArgs) Handles uxEarthquakeGraph.NeedDataSource, uxWindstormGraph.NeedDataSource, uxConstructionGraph.NeedDataSource, uxOccupancyGraph.NeedDataSource, uxOtherExposureGraph.NeedDataSource, uxFloodGraph.NeedDataSource
