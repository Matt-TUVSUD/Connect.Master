<%@ Page Title="Rec. Response Grid | Global Risk Consultants" Language="vb" AutoEventWireup="false" MasterPageFile="~/RecResponse_{{VER}}/ClientConnectRecResponse.Master" CodeBehind="recdatasheetfeaturesL.aspx.vb" Inherits="GRC.Connect.Web.recdatasheetfeaturesL_ps_recresponse" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Lib_{{VER}}/Generated/ViewCCPSRecommendationGrid.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Custom/ViewCCPSRecommendationGrid.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="tableDiv" style="width: 100%;">
        ...
        <div class="tabRow">
            ...
            <span class="companyLabels3" style="width:96px;"><label class="recLabelVerticalCenter" data-bind="text: $parent.objLanguageLabels().lblFacilityName">Facility Name</label></span>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var view = {
            ...
            collRec: new es.objects.ViewCCPSRecommendationGridCollection(),
            ...
            createGridObject: function () {
                if (view.enableMgmtFields() == false) {
                    ...
                    { field: "CurrentLEActual", width: "250px", title: view.objLanguageLabels().lblCurrentLEActual },
                    { field: "CurrentLERange", width: "250px", title: view.objLanguageLabels().lblCurrentLERange },
                    { field: "CompletedLEActual", width: "250px", title: view.objLanguageLabels().lblCompletedLEActual },
                    { field: "CompletedLERange", width: "250px", title: view.objLanguageLabels().lblCompleteLERange },
                    { field: "EstCostToCompleteActual", width: "250px", title: view.objLanguageLabels().lblEstCostToCompleteActual },
            ...
            createColumnTitles: function () {
                ...
                view.columnTitles.push(view.objLanguageLabels().lblCurrentLEActual);
                view.columnTitles.push(view.objLanguageLabels().lblCurrentLERange);
                view.columnTitles.push(view.objLanguageLabels().lblCompletedLEActual);
                view.columnTitles.push(view.objLanguageLabels().lblCompleteLERange);
                view.columnTitles.push(view.objLanguageLabels().lblEstCostToCompleteActual);
            ...
            loadFileNumber: function () {
                ...
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view.collListing.GetRecResponsePSLocationByFileNo(tempParm + "|" + tempHemisphere)) {

                    es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                    if (!view.collRec.GetPSRecommendationGridByFileNo(tempParm + "|" + tempHemisphere)) {
            ...
            loadCollections: function () {
                ...
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view.collPrimaryrectype.GetPrimaryRecTranslationByLanguage(view.preferenceLanguage + "|" + "B&M")) { } else { view.messageError("* Error while loading Primary Rec Data List."); }
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view.collSecondaryrectype.GetSecondaryRecTranslationByLanguage(view.preferenceLanguage + "|" + "B&M")) { } else { view.messageError("* Error while loading Secondary Rec Data List."); }
            }
        };
