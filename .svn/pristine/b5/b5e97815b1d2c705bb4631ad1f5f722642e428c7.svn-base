...
(function (es) { //myNS = "myNameSpace" ... for example purposes
	...
	es.objects.ViewCCLocationInspectionIR = es.defineEntity(function () {
	...
	es.objects.ViewCCLocationInspectionIR.prototype.esTypeDefs = {};

	es.objects.ViewCCLocationInspectionIR.prototype.esRoutes = {
		commit: { method: 'PUT', url: 'ViewCCLocationInspectionIR_Save', response: 'entity' }
	};

	es.objects.ViewCCLocationInspectionIR.prototype.esColumnMap = {
		'FileNo': 1,
		'PracticeCode': 1,
		'Engineer': 1,
		'LocationStatus': 1,
...
(function (es) {
	...
	es.objects.ViewCCLocationInspectionIRCollection = es.defineCollection('ViewCCLocationInspectionIRCollection', 'ViewCCLocationInspectionIR');

	//#region Prototype Level Information

	es.objects.ViewCCLocationInspectionIRCollection.prototype.esRoutes = {
		commit: { method: 'PUT', url: 'ViewCCLocationInspectionIRCollection_Save', response: 'collection' },
		loadAll: { method: 'GET', url: 'ViewCCLocationInspectionIRCollection_LoadAll', response: 'collection' }
	};
