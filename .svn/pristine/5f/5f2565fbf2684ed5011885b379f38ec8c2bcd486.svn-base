<%@ Page Title="Rec. Response Grid | Global Risk Consultants" Language="vb" AutoEventWireup="false" MasterPageFile="~/RecResponse_{{VER}}/ClientConnectRecResponse.Master" CodeBehind="recdatasheetfeaturesL.aspx.vb" Inherits="GRC.Connect.Web.recdatasheetfeaturesL_fire_recresponse" %>
