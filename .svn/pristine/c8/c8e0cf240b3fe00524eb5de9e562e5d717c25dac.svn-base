<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tab_rectrackingfeaturesX.aspx.vb" Inherits="GRC.Connect.Web.tab_rectrackingfeaturesX_fire" %>
    ...
    <div id="view_RecTracking" data-bind="with: view_RecTracking">
        ...
        <div id="windowNoLocation" class="windowContent" style="font-size:13px;">
            ...
            <div style="margin-bottom:5px;">
                <label data-bind="text: $parent.objLanguageLabels().lblNoLocationFoundMessage">Warning: There are no recommendation records found for this location.</label></div>
        ...
        $(document).ready(function () {
            ...
            var view_RecTracking = {
                ...
                loadOneFileNumber: function () {
                    ...
                    tempParm = view_RecTracking.gSafeGuid + "|" + tempHemisphere + "|one|False";
                    es.dataProvider.baseURL = SITEBASEURL + RESTSERVERENDPOINT;
