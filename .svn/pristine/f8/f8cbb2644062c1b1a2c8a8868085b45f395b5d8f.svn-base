<%@ Page Title="Rec. Response Grid | Global Risk Consultants" Language="vb" AutoEventWireup="false" MasterPageFile="~/RecResponse_{{VER}}/ClientConnectRecResponse.Master" CodeBehind="recdatasheet.aspx.vb" Inherits="GRC.Connect.Web.recdatasheet_infrared_recresponse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="tableDiv" style="width: 100%;">
        ...
        <div class="tabRow">
            ...
            <span class="companyInputs5" style="width:96px;"><input readonly="true" data-bind="value: $parent.objListing().Facility" id="Facility" class="k-autocomplete k-input inputNoEdit inputLeft companyInputs5" tabindex="11"  /></span>
        </div>
        <div class="tabRow">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        //            lblSearchNotFound: "No location was found. Please click the 'Clear Find' button to try again.",
        //            //// REC RESPONSE SPECIFIC
        //            lblResponsesNeeded: "Responses Needed",
        //            lblResponsesCompleted: "Responses Completed",
        //            lblClickToViewCurrentReport: "Click to View Current Report",
        //            lblClickToViewLatestDiagram: "Click to View Latest Diagram",
        //            lblClickHere: "Click Here",
        //            lblChooseLanguage: "Choose Language",
        //            lblPleaseLogOutAndTryAgain: "Please log out and try again.",
        //            lbl: ""
        //        };
        ...
        var view = {
            ...
            createGridObject: function () {
                if (view.enableMgmtFields() == false) {
                    ...
                    { field: "IdWeb", width: "0px", title: "", filterable: false, sortable: false, template: "<a name='#=IdWeb#' id='#=IdWeb#'>#=IdWeb#</a>" },
                    { field: "RecYear", width: "100px", title: view.objLanguageLabels().lblRecYear },
                    { field: "RecMonth", width: "100px", title: view.objLanguageLabels().lblRecMonth },
                    ...
                    { field: "Severityrating", width: "150px", title: view.objLanguageLabels().lblSeverity },
                    { field: "Impact", width: "200px", title: view.objLanguageLabels().lblRecImpact },
                    { field: "RecPrimary", width: "250px", title: view.objLanguageLabels().lblPrimaryRecType },
                    { field: "RecSecondary", width: "250px", title: view.objLanguageLabels().lblSecondaryRecType },
                    { field: "Recommendation", width: "450px", title: view.objLanguageLabels().lblRecKeyWord, template: "#= Recommendation.length > 75 ? Recommendation.substr(0, 75) + ' ...': Recommendation #" },
                    { field: "History", width: "150px", title: view.objLanguageLabels().lblHistory },
                    { field: "Itemno", width: "125px", title: view.objLanguageLabels().lblEquipNo },
                    { field: "Findingno", width: "125px", title: view.objLanguageLabels().lblFindingNo },
                    { field: "PlantAreaAffected", width: "250px", title: view.objLanguageLabels().lblPlantAreaAffected },
                    { field: "ProbableEquipmentDamageCost", width: "250px", title: view.objLanguageLabels().lblProbableEquipmentDamage },
                    { field: "FaultType", width: "150px", title: view.objLanguageLabels().lblIRRecFaultType },
                    { field: "DetectedWith", width: "150px", title: view.objLanguageLabels().lblIRRecDetectedWith },
                    { field: "RedundancySpare", width: "250px", title: view.objLanguageLabels().lblIRRecRedundancySpare },
                    { field: "IntendedAction", width: "325px", title: view.objLanguageLabels().lblRecIntendedAction },
                    { field: "ResponseDate", width: "150px", title: view.objLanguageLabels().lblRespDate, template: "#= (ResponseDate == null || ResponseDate == undefined || ResponseDate == '' || ResponseDate == '1/1/00' || ResponseDate == '1/1/1900' || ResponseDate == '01-Jan-00' || ResponseDate == 'Mon Jan 1 00:00:00 EST 1900' || ResponseDate.toString().indexOf('1900') > -1 || ResponseDate.toString().indexOf('1899') > -1) ? ' ' : kendo.toString(ResponseDate, 'dd-MMM-yy') #" },
                    { field: "ResponseFrom", width: "175px", title: view.objLanguageLabels().lblRespForm },
                    { field: "PlantComment", width: "450px", title: view.objLanguageLabels().lblFacilityComment, template: "#= PlantComment.length > 75 ? PlantComment.substr(0, 75) + ' ...': PlantComment #" },
                    { field: "ExpectedCompletionDate", width: "250px", title: view.objLanguageLabels().lblExpdComplDate, template: "#= (ExpectedCompletionDate == null || ExpectedCompletionDate == undefined || ExpectedCompletionDate == '' || ExpectedCompletionDate == '1/1/00' || ExpectedCompletionDate == '1/1/1900' || ExpectedCompletionDate == '01-Jan-00' || ExpectedCompletionDate == 'Mon Jan 1 00:00:00 EST 1900' || ExpectedCompletionDate.toString().indexOf('1900') > -1 || ExpectedCompletionDate.toString().indexOf('1899') > -1) ? ' ' : kendo.toString(ExpectedCompletionDate, 'dd-MMM-yy') #" }
                ]
                    }).data("kendoGrid");
                } else {
                    gridRecDatasheet = $("#gridRecDatasheet").kendoGrid({
            ...
            createColumnTitles: function() {
                ...
                view.columnTitles.push(view.objLanguageLabels().lblSeverity);
                ...
                view.columnTitles.push(view.objLanguageLabels().lblHistory);
                view.columnTitles.push(view.objLanguageLabels().lblEquipNo);
                view.columnTitles.push(view.objLanguageLabels().lblFindingNo);
                view.columnTitles.push(view.objLanguageLabels().lblPlantAreaAffected);
                view.columnTitles.push(view.objLanguageLabels().lblProbableEquipmentDamage);
                view.columnTitles.push(view.objLanguageLabels().lblIRRecFaultType);
                view.columnTitles.push(view.objLanguageLabels().lblIRRecDetectedWith);
                view.columnTitles.push(view.objLanguageLabels().lblIRRecRedundancySpare);
                ...
                for (y = 0; y < view.collRec().length; y++) {
                    if (view.collRec()[y].FileNo() == view.objListing().FileNo()) {
                        view.collGrid().push({
                            ...
                            Impact: view.translateImpact(view.collRec()[y].Impact()),
                            ...
                            RecPrimary: view.translatePrimaryRecType(view.collRec()[y].RecPrimary()),
                            RecSecondary: view.translateSecondaryRecType(view.collRec()[y].RecSecondary()),
            ...
            loadFileNumber: function () {
                ...
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view.collListing.GetRecResponseIRLocationByFileNo(tempParm + "|" + tempHemisphere)) {

                    es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                    if (!view.collRec.GetIRRecommendationGridByFileNo(tempParm + "|" + tempHemisphere)) {
            ...
            loadCollections: function() {
                ...
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view.collPrimaryrectype.GetPrimaryRecTranslationByLanguage(view.preferenceLanguage + "|" + "Infrared")) { } else { view.messageError("* Error while loading Primary Rec Data List."); }
                es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                if (!view.collSecondaryrectype.GetSecondaryRecTranslationByLanguage(view.preferenceLanguage + "|" + "Infrared")) { } else { view.messageError("* Error while loading Secondary Rec Data List."); }
            }
        };
    ...
    function onEnter(e) {
        ...
        var tempUrl = "rectracking.aspx?f1=" + "<%= ServerSide_FileNo %>" + "&rec=" + dataItem.IdWeb;
