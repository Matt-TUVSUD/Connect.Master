...
Public Class BmCopeDataReport_RotatingElectEquipment
    ...
    Private Function GetDataSource() As DataTable
        ...
        Dim zCmd As New SqlClient.SqlCommand("SELECT * FROM rv.vwBMCopeElecRotEquipment WHERE filePrefix='" & rptProperties.FilePrefix & "'", zCon)
    ...
    End Function
     ...
     Private Sub BmCopeDataReport_RotatingElectEquipment_NeedDataSource(sender As Object, e As System.EventArgs) Handles Me.NeedDataSource
        Me.DataSource = GetDataSource() ' ReportQuery.SubQueries.BoilerFacilityData_RotatingElectricalEquipment
     End Sub
