...
Partial Public Class BoilerFacilityRatingActiveTrendingReport
    ...
    Public Sub New()
        ...
        With _GraphBind
            .Add("uxMechMaintGraph", "Mech")
            .Add("uxElectMaintGraph", "Elec")
            .Add("uxCriticalSpareGraph", "Spares")
            .Add("uxHumanElementGraph", "Human")
    ...
    Public Function ReportTitle() As String Implements ITelerikReport.ReportTitle
        Return "Facility Rating Management Programs Trending Chart"
    End Function
    ...
    Private Sub GraphNeedDataSourceHandler(sender As Object, e As EventArgs) Handles uxMechMaintGraph.NeedDataSource, uxElectMaintGraph.NeedDataSource, uxCriticalSpareGraph.NeedDataSource, uxHumanElementGraph.NeedDataSource, uxBCPGraph.NeedDataSource
