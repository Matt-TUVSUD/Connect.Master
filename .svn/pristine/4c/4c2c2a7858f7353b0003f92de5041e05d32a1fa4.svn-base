<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tab_recdatasheetfeaturesL.aspx.vb" Inherits="GRC.Connect.Web.tab_recdatasheetfeaturesL_nathaz" %>
...
<head runat="server">
    ...
    <script src="../../Lib_{{VER}}/Generated/ViewCCNHRecommendationGrid.js" type="text/javascript"></script>
    <script src="../../Lib_{{VER}}/Custom/ViewCCNHRecommendationGrid.js" type="text/javascript"></script>
</head>
<body>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var view_RecDatasheet = {
                ...
                collRec: new es.objects.ViewCCNHRecommendationGridCollection(),
                ...
                onExport: function () {
                    ...
                    var Content = "";
                    var Footer = "";
                    Header = buildXMLRecHeader_Features_L();
                    Content = buildXMLString_Features_L(gridRecDatasheet.dataSource._view, view_RecDatasheet.objListing());
                ...
                loadFileNumber: function () {
                    ...
                    //if (!view_RecDatasheet.collListing.ViewCCLocationNHRecommendationCollections(tempParm)) {
                    if (!view_RecDatasheet.collListing.ViewCCLocationNHCollections(tempParm)) {
                        es.dataProvider.baseURL = SITEBASEURL + VIEWSERVERENDPOINT;
                        if (!view_RecDatasheet.collRec.viewCCNHRecommendationGridCollection(view_RecDatasheet.gSafeGuid + "|" + tempHemisphere)) {
