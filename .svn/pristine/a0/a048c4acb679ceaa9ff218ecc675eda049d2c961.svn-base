...
Public Class recdatasheetfeaturesL_boiler_recresponse
    ...
    Private Sub loadData()
        ...
        Dim zObjListing As New ViewCCLocationListingBM
        ...
        If zObjListing.Load(zQryListing) Then
            ServerSide_ToFireReport = Replace(zObjListing.ToBMReport, "\", "\\")
            ServerSide_ToFireDiagram = Replace(zObjListing.ToBMDiagram, "\", "\\")
        End If
