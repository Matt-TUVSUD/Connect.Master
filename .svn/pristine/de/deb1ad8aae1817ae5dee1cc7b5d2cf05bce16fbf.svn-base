<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PreFilter.aspx.vb" Inherits="GRC.Connect.Web.PreFilter_Chart" %>
...
<body class="windowPleaseWait_Body">
    ...
    <form id="form1" runat="server">
        <div id="" class="windowPleaseWait_Content">
            ...
            <asp:HiddenField ID="hidChartUrlBase" ClientIDMode="Static" runat="server" Value="" />
            ...
            <div id="divTablePrefilters" runat="server" style="width:100%;">
                ...
                <div runat="server" id="divDivision" class="prefilterRow">
                    <span class="">
                        <asp:Label runat="server" id="lblDivision">Division</asp:Label>
                    </span>
                    <span class="">
                        <telerik:RadComboBox ID="cboDivision" runat="server"></telerik:RadComboBox>
                    </span>
                </div>
                <div runat="server" id="divInspectionProgramYear" class="prefilterRow">
                    <span class="">
                        <asp:Label runat="server" id="lblInspectionProgramYear">Inspection Program Year</asp:Label>
                    </span>
                    <span class="">
                        <telerik:RadComboBox ID="cboInspectionProgramYear" runat="server"></telerik:RadComboBox>
                    </span>
                </div>
                <div runat="server" id="divCurrency" class="prefilterRow">
                    <span class="">
                        <asp:Label runat="server" id="lblCurrency">Currency</asp:Label>
                    </span>
                    <span class="">
                        <telerik:RadComboBox ID="cboCurrency" runat="server"></telerik:RadComboBox>
                    </span>
                </div>
                <div runat="server" id="divTIV" class="prefilterRow">
                    <span class="">
                        <asp:Label runat="server" id="lblTIV">TIV</asp:Label>
                    </span>
                    <span class="">
                        <telerik:RadComboBox ID="cboTIV" runat="server"></telerik:RadComboBox>
                    </span>
                </div>
                <div runat="server" id="divUnits" class="prefilterRow">
                    <span class="">
                        <asp:Label runat="server" id="lblUnits">Units</asp:Label>
                    </span>
                    <span class="">
                        <telerik:RadComboBox ID="cboUnits" runat="server"></telerik:RadComboBox>
                    </span>
                </div>
                <div runat="server" id="divStatus" class="prefilterRow">
                    ...
                    <span class="">
                        <telerik:RadComboBox ID="cboStatus" runat="server"></telerik:RadComboBox>
                    </span>
                </div>
                <div runat="server" id="divDateFrom" class="prefilterRow">
                    <span class="">
                        <asp:Label runat="server" id="lblDateFrom">Date From</asp:Label>
                    </span>
                    <span class="">
                        <telerik:RadDatePicker ID="dteDateFrom" runat="server"></telerik:RadDatePicker>
                    </span>
                </div>
                <div runat="server" id="divDateTo" class="prefilterRow">
                    <span class="">
                        <asp:Label runat="server" id="lblDateTo">Date To</asp:Label>
                    </span>
                    <span class="">
                        <telerik:RadDatePicker ID="dteDateTo" runat="server"></telerik:RadDatePicker>
                    </span>
                </div>
                <div runat="server" id="divHazard" class="prefilterRow">
                    <span class="">
                        <asp:Label runat="server" id="lblHazard">Hazard</asp:Label>
                    </span>
                    <span class="">
                        <telerik:RadComboBox ID="cboHazard" runat="server"></telerik:RadComboBox>
                    </span>
                </div>
                <div runat="server" id="divCountry" class="prefilterRow">
                    ...
                    <span class="">
                        <telerik:RadComboBox ID="cboCountry" runat="server"></telerik:RadComboBox>
                    </span>
                </div>
                <div runat="server" id="divTIVValue" class="prefilterRow">
                    <span class="">
                        <asp:Label runat="server" id="lblTIVValue">TIV Value</asp:Label>
                    </span>
                    <span class="">
                        <telerik:RadComboBox ID="cboTIVValue" runat="server"></telerik:RadComboBox>
                    </span>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (noPrefilters.toLocaleLowerCase() == "true") {
            setTimeout(function () {
                var chartUrl = "<%= ServerSide_ChartUrl %>";
                tempWindow.setUrl("../../Home_{{VER}}/Reports/blank.aspx");
                tempWindow.close();
                openRequestedSinglePrefilterPopup(chartUrl);
            }, 1500);
        } else {
