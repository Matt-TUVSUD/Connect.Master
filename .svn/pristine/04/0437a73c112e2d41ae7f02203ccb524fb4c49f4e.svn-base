<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="tab_recdatasheet.aspx.vb" Inherits="GRC.Connect.Web.tab_recdatasheet_nathaz" %>
...
<body>
    ...
    <div id="view_RecDatasheet" data-bind="with: view_RecDatasheet">
        ...
        <div id="windowNoLocation" class="windowContent" style="font-size:13px;">
            ...
            <div style="justify-content: center;"><button class="grcBlueBtn" style="padding: 6px;" data-bind="text: $parent.objLanguageLabels().lblGoBackToDetails, click: $parent.onLocationDetailsRedirect">Go Back To Location Details</button></div>
        </div>
            ...
            var view_RecDatasheet = {
                ...
                onExport: function () {
                    ...
                    if (view_RecDatasheet.clientFeatures().indexOf("Q") > -1) {
                        ...
                        Content = buildXMLStringMgmt(gridRecDatasheet.dataSource._view, view_RecDatasheet.objListing());
                        Footer = buildXMLRecFooter();
                    } else {
                        Header = buildXMLRecHeader();
                        Content = buildXMLString(gridRecDatasheet.dataSource._view, view_RecDatasheet.objListing());
                        Footer = buildXMLRecFooter();
                    }
                        ...
                        if (view_RecDatasheet.clientFeatures().indexOf("Q") > -1) {
                            if (view_RecDatasheet.collRec()[y].FileNo() == view_RecDatasheet.objListing().FileNo()) {
                                view_RecDatasheet.collGrid().push({
                                    ...
                                    RecImpact: view_RecDatasheet.collRec()[y].RecCode(),
