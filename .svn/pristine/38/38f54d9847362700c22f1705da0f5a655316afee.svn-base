...
Public Class tab_rectrackingfeaturesX_fire
    Inherits System.Web.UI.Page

    Private Sub ValidatePage()
        'CorrectPageCheck(GetGUIDFromQueryString, PageId_RecommendationTracking_Fire_Feature_X, PageId_LocationListing_Fire)
    ...
    Private Sub loadDefaults()
        ...
        'SetFireRecommendationTracking_FeatureX(zGUID)
        ...
        If Not Request.UrlReferrer Is Nothing Then
            If Request.UrlReferrer.ToString.Length > 0 Then
                If InStr(Request.UrlReferrer.LocalPath.ToLower, "SiteMap/Default.aspx".ToLower) > 0 Then
                    ...
                    Response.Redirect("~/Home_{{VER}}/Grids/LocationListings/LocationListings.aspx?sid=" & zGUID & "&pLandingPage=rectrackingfeaturesx", False)
                End If
            End If
        End If
